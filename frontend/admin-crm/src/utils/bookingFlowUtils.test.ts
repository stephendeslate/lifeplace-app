...
describe("getEventTypeDisplayName", () => {
  ...
  it("returns All Event Types for undefined", () => {
    expect(getEventTypeDisplayName(makeFlow(undefined))).toBe(
      "All Event Types",
    );
  });

  it('returns All Event Types for "Any Event Type"', () => {
    expect(getEventTypeDisplayName(makeFlow("Any Event Type"))).toBe(
      "All Event Types",
    );
  });

  it('returns All Event Types for "All Event Types"', () => {
    expect(getEventTypeDisplayName(makeFlow("All Event Types"))).toBe(
      "All Event Types",
    );
  });
