...
} from "../../../components/common/ModernForm";
import {
...
const ProgramSettingsTab = () => {
  const { settings, isLoadingSettings, updateSettings, isUpdatingSettings } =
    useVIPSettings();
  ...
  const settingsFormSections: ModernFormSection[] = [
      ...
      fields: [
        {
          ...
          type: "switch",
          helperText:
            "Automatically upgrade tiers based on spending or bookings",
        },
        {
    ...
    },
    {
      ...
      description:
        "Configure how points are earned (when points system is enabled).",
      fields: [
        {
        ...
        },
        {
          ...
          type: "number",
          helperText:
            "Amount that earns the points above (e.g., 100 = 1 point per 100 PHP)",
        },
        {
