...
export function createMockSupportInquiry(
  overrides: Partial<SupportInquiry> = {},
): SupportInquiry {
...
export function createMockSupportMessage(
...
export function createMockSupportStats(
  overrides: Partial<SupportStats> = {},
): SupportStats {
  return {
    total: 45,
    open: 12,
