...
export const salesHandlers = [
  ...
  http.get(`${BASE_URL}/sales/templates/for_event_type/`, async ({ request }) => {
    await delay(30);
    ...
    const filtered = eventType
      ? quoteTemplatesStore.filter((t) => t.event_type === parseInt(eventType) && t.is_active)
  ...
  http.post(`${BASE_URL}/sales/templates/`, async ({ request }) => {
    ...
    const newTemplate = {
      ...
      default_service_charge_rate: (body.default_service_charge_rate as string) || '0.10',
      products: [],
  ...
  http.patch(`${BASE_URL}/sales/templates/:id/`, async ({ params, request }) => {
    await delay(50);
  ...
  http.patch(`${BASE_URL}/sales/template-products/:id/`, async ({ params, request }) => {
    await delay(50);
  ...
  http.delete(`${BASE_URL}/sales/template-products/:id/`, async ({ params }) => {
    await delay(50);
  ...
  http.post(`${BASE_URL}/sales/quotes/:id/reject/`, async ({ params, request }) => {
    await delay(50);
  ...
  http.post(`${BASE_URL}/sales/quotes/:id/sign/`, async ({ params, request }) => {
    await delay(50);
  ...
  http.get(`${BASE_URL}/sales/quotes/:quoteId/activities/`, async ({ params }) => {
    await delay(30);
  ...
  http.post(`${BASE_URL}/sales/quotes/:quoteId/reminders/`, async ({ params, request }) => {
    await delay(50);
  ...
  http.patch(`${BASE_URL}/sales/line-items/:id/`, async ({ params, request }) => {
    await delay(50);
  ...
  http.post(`${BASE_URL}/sales/line-items/calculate_pricing/`, async ({ request }) => {
    await delay(50);
