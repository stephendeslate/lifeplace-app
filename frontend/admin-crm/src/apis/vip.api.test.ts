...
describe('vipApi', () => {
  ...
  describe('assignTier', () => {
    it('calls POST with assign_tier endpoint', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/vip/client-status/1/assign_tier/', data);
  ...
  describe('awardPoints', () => {
    it('calls POST with award_points endpoint', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/vip/client-status/1/award_points/', data);
