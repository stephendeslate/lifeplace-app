...
describe('eventsApi', () => {
  ...
  describe('createEventType', () => {
    ...
    it('posts FormData with multipart header when formData provided', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/events/event-types/', formData, {
  ...
  describe('updateEventType', () => {
    it('patches JSON data when no formData provided', async () => {
      ...
      expect(mockApi.patch).toHaveBeenCalledWith('/events/event-types/1/', data);
    ...
    it('patches FormData with multipart header when formData provided', async () => {
      ...
      expect(mockApi.patch).toHaveBeenCalledWith('/events/event-types/1/', formData, {
        headers: { 'Content-Type': 'multipart/form-data' },
      });
    });
  });
  ...
  describe('createEventFile', () => {
    it('posts FormData with file and metadata', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/events/event-files/', expect.any(FormData), {
        headers: { 'Content-Type': 'multipart/form-data' },
      });
  ...
  describe('updateEventFile', () => {
    it('patches event file with FormData', async () => {
      ...
      expect(mockApi.patch).toHaveBeenCalledWith('/events/event-files/1/', expect.any(FormData), {
        headers: { 'Content-Type': 'multipart/form-data' },
      });
    });
  ...
  describe('downloadEventFile', () => {
    it('fetches file blob with responseType blob', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/events/event-files/15/download/', {
        responseType: 'blob',
      });
      expect(result).toBe(mockBlob);
    });
  ...
  describe('getCheckInStatus', () => {
    it('fetches check-in status for an event', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/events/events/1/check_in_status/');
  ...
  describe('updateHeadcount', () => {
    it('posts headcount update data to event endpoint', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/events/events/7/update_headcount/', data);
      expect(result).toEqual(mockResponse);
    });
  });
  ...
  describe('previewLateCheckoutFee', () => {
    it('fetches late checkout fee preview for an event', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/events/events/1/late_checkout_preview/');
  ...
  describe('getEventFileBlob', () => {
    it('fetches file blob via download endpoint', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/events/event-files/5/download/', {
        responseType: 'blob',
      });
      expect(result).toBe(mockBlob);
    });
