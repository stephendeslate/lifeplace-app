...
describe('contractsApi', () => {
  ...
  describe('updateContractTemplate', () => {
    it('patches template data at /contracts/templates/:id/', async () => {
      ...
      const result = await contractsApi.updateContractTemplate(1, data as never);

      expect(mockApi.patch).toHaveBeenCalledWith('/contracts/templates/1/', data);
      expect(result).toEqual({ id: 1, ...data });
    });
  });
  ...
  describe('getTemplatesForEventType', () => {
    it('fetches templates filtered by event type', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/contracts/templates/for_event_type/?event_type=3');
  ...
  describe('previewTemplate', () => {
    it('posts context data to preview endpoint', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/contracts/templates/1/preview/', {
  ...
  describe('getVariableSchemas', () => {
    it('fetches variable schemas from /contracts/templates/variable_schemas/', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/contracts/templates/variable_schemas/');
  ...
  describe('updateEventContract', () => {
    it('patches contract data at /contracts/contracts/:id/', async () => {
      ...
      expect(mockApi.patch).toHaveBeenCalledWith('/contracts/contracts/1/', data);
      expect(result).toEqual({ id: 1, ...data });
    });
  });
  ...
  describe('getContractsForEvent', () => {
    it('fetches contracts for a specific event', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/contracts/contracts/for_event/?event_id=5');
  ...
  describe('addSignature', () => {
    it('posts signature data to contract', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/contracts/contracts/5/add_signature/', data);
      expect(result).toEqual({ id: 1, ...data });
    });
  });
  ...
  describe('voidContract', () => {
    it('posts void request with optional reason', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/contracts/contracts/5/void/', {
  ...
  describe('requestAmendment', () => {
    it('posts amendment data to contract', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/contracts/contracts/5/request_amendment/', data);
      expect(result).toEqual({ id: 1, ...data });
    });
  });
  ...
  describe('getContractAmendments', () => {
    it('fetches amendments for a specific contract', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/contracts/contracts/5/amendments/');
  ...
  describe('getContractDocuments', () => {
    it('fetches documents for a specific contract', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/contracts/contracts/5/documents/');
  ...
  describe('addContractNote', () => {
    it('posts note data to contract', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/contracts/contracts/5/add_note/', data);
      expect(result).toEqual({ id: 1, ...data });
    });
  });
  ...
  describe('verifySignature', () => {
    it('posts verification request with optional method', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/contracts/signatures/1/verify/', {
  ...
  describe('approveAmendment', () => {
    it('posts approval with optional review notes', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/contracts/amendments/1/approve/', {
  ...
  describe('rejectAmendment', () => {
    it('posts rejection with optional review notes', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/contracts/amendments/1/reject/', {
  ...
  describe('createAmendmentContract', () => {
    it('posts context data to create contract from amendment', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/contracts/amendments/1/create_contract/', {
  ...
  describe('createContractDocument', () => {
    it('posts FormData with file to /contracts/documents/', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/contracts/documents/', expect.any(FormData), {
        headers: { 'Content-Type': 'multipart/form-data' },
      });
  ...
  describe('getContractsForClient', () => {
    it('fetches contracts for a specific client', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/contracts/contracts/?client_id=10');
      expect(result).toEqual(mockContracts);
    });
  });
  ...
  describe('downloadContractPdf', () => {
    it('fetches contract PDF as blob', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/contracts/contracts/5/download_pdf/', {
        responseType: 'blob',
      });
  ...
  describe('sendContract', () => {
    it('posts to send_contract endpoint', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/contracts/contracts/5/send_contract/');
      expect(result).toEqual(mockContract);
    });
  });
