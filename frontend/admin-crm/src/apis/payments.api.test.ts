...
describe('paymentsApi', () => {
  ...
  describe('processPayment', () => {
    it('posts process data to /payments/payments/:id/process/', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/payments/payments/5/process/', data);
  ...
  describe('sendReceipt', () => {
    it('posts to send_receipt endpoint', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/payments/payments/5/send_receipt/');
  ...
  describe('sendReminder', () => {
    it('posts to send_reminder endpoint', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/payments/payments/5/send_reminder/');
  ...
  describe('createPaymentPlan', () => {
    it('posts plan data to /payments/payment-plans/', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/payments/payment-plans/', data);
      expect(result).toEqual({ id: 1, ...data });
    });
  });
  ...
  describe('updatePaymentPlan', () => {
    it('patches plan data at /payments/payment-plans/:id/', async () => {
      ...
      expect(mockApi.patch).toHaveBeenCalledWith('/payments/payment-plans/1/', data);
      expect(result).toEqual({ id: 1, ...data });
    });
  });
  ...
  describe('createPaymentFromInstallment', () => {
    it('posts to /payments/installments/:id/create_payment/', async () => {
      ...
      const result = await paymentsApi.createPaymentFromInstallment(5, data as never);

      expect(mockApi.post).toHaveBeenCalledWith('/payments/installments/5/create_payment/', data);
  ...
  describe('sendInvoice', () => {
    it('posts to send_invoice endpoint', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/payments/invoices/5/send_invoice/');
  ...
  describe('downloadInvoicePdf', () => {
    it('fetches invoice PDF as blob', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/payments/invoices/5/download_pdf/', {
        responseType: 'blob',
      });
  ...
  describe('getInvoicesForClient', () => {
    it('fetches invoices filtered by client ID and extracts results', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/payments/invoices/?client_id=10');
      expect(result).toEqual(mockInvoices);
    });
  });
  ...
  describe('partialUpdatePaymentSettings', () => {
    it('patches settings data at /payments/settings/:id/', async () => {
      ...
      const result = await paymentsApi.partialUpdatePaymentSettings(1, data as never);
  ...
  describe('getPaymentMethodsForUser', () => {
    it('fetches payment methods for a specific user', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/payments/payment-methods/for_user/?user_id=42');
      expect(result).toEqual(mockMethods);
    });
  });
});
