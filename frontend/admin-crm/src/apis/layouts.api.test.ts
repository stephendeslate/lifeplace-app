...
describe('layoutsApi', () => {
  ...
  describe('previewLayout', () => {
    it('calls POST to preview endpoint with data', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/communications/layouts/5/preview/', previewData);
  ...
  describe('rollbackLayout', () => {
    it('calls POST with version in body', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/communications/layouts/5/rollback/', {
        version: 2,
      });
  ...
  describe('getLayoutTemplates', () => {
    it('calls GET to templates endpoint', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/communications/layouts/5/templates/');
  ...
  describe('duplicateLayout', () => {
    it('calls POST with new_name in body', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/communications/layouts/5/duplicate/', {
        new_name: 'Copy',
      });
