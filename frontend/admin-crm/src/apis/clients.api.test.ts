...
describe('clientsApi', () => {
  ...
  describe('importClients', () => {
    it('posts FormData with file to /clients/import/ with multipart header', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/clients/import/', expect.any(FormData), {
  ...
  describe('acceptInvitation', () => {
    it('posts acceptance data for a client invitation', async () => {
      ...
      const result = await clientsApi.acceptInvitation('inv-abc', data as never);

      expect(mockApi.post).toHaveBeenCalledWith('/clients/invitations/inv-abc/accept/', data);
      expect(result).toEqual(mockResponse);
    });
  });
});
