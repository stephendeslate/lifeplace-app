...
export const workflowsApi = {
  ...
  disableAutomationForEvent: async (
    eventId: number,
    stageId: number,
    reason?: string,
  ): Promise<EventWorkflowOverride> => {
