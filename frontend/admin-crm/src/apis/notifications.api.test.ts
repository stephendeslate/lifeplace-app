...
describe('notificationsApi', () => {
  ...
  describe('markAsRead', () => {
    it('calls POST to mark_read endpoint', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/notifications/notifications/1/mark_read/');
  ...
  describe('markAllAsRead', () => {
    it('calls POST to mark_all_read endpoint', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/notifications/notifications/mark_all_read/');
  ...
  describe('getMyPreferences', () => {
    it('calls GET on my_preferences endpoint', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/notifications/preferences/my_preferences/');
  ...
  describe('sendTestPush', () => {
    it('calls POST to test_push endpoint', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/notifications/push-tokens/test_push/', data);
