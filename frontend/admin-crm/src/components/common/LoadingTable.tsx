          ...
          <TableRow key={rowIndex}>
            {Array.from({ length: columns }, (_, colIndex) => (
              <TableCell key={colIndex}>
                <Skeleton variant="text" width={colIndex === 0 ? '60%' : '40%'} height={20} />
              </TableCell>
            ))}
          </TableRow>
        ))}
...
export const LoadingMetricsTable: React.FC = () => <LoadingTable variant="list" rows={6} />;

export const LoadingDashboardCards: React.FC = () => <LoadingTable variant="cards" rows={6} />;

export const LoadingReportsTable: React.FC = () => <LoadingTable rows={8} columns={8} />;

export const LoadingEventsTable: React.FC = () => <LoadingTable rows={10} columns={7} />;

export const LoadingAlertRulesTable: React.FC = () => <LoadingTable rows={6} columns={9} />;
