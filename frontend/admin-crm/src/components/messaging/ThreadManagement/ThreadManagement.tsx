...
import type { ThreadManagementProps, CreateThreadRequest, MessagePriority, MessageThreadStatus } from '../../../types/messaging.types';

// Type for update thread request (not yet in stubs)
