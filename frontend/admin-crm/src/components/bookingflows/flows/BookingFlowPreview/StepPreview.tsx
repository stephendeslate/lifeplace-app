// frontend/admin-crm/src/components/bookingflows/flows/BookingFlowPreview/StepPreview.tsx

import React from 'react';
import { Box, Typography, Chip, Stack, Alert, Divider } from '@mui/material';
import {
...
const getStepIcon = (step: BookingFlowStep, isActive: boolean, isCompleted: boolean) => {
...
const StepContent: React.FC<{ step: BookingFlowStep }> = ({ step }) => {
            ...
            <Box mt={2}>
              <Stack direction="row" spacing={1} flexWrap="wrap">
                ...
                {contactConfig.offer_account_creation && (
                  <Chip
                    label="Account Creation Offered"
                    size="small"
                    color="info"
                    variant="outlined"
                  />
            ...
            <Box>
              <Stack direction="row" spacing={1} flexWrap="wrap">
                ...
                {paymentConfig.accept_deposit && (
                  <Chip label="Deposit Payment" size="small" color="info" variant="outlined" />
                )}
