        ...
        <Stack spacing={3}>
          ...
          <Box>
            ...
            <Alert severity="warning" sx={{ mb: 2 }}>
              <strong>Important:</strong> Controls when dates become officially blocked for
              bookings.
              <br />
                  ...
                  {(formData.child_pricing_tiers || []).map((tier, index) => (
                    <Box key={index} sx={{ display: 'flex', gap: 1, alignItems: 'flex-start' }}>
                      <TextField
                        ...
                        value={tier.min_age}
                        onChange={(e) =>
                          handleUpdateChildTier(index, 'min_age', parseInt(e.target.value) || 0)
                        }
                        size="small"
                        sx={{ width: 100 }}
                      />
                      <TextField
                        ...
                        value={tier.max_age}
                        onChange={(e) =>
                          handleUpdateChildTier(index, 'max_age', parseInt(e.target.value) || 0)
                        }
                        size="small"
                        sx={{ width: 100 }}
                      />
