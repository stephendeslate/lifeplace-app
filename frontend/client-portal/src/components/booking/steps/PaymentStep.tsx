        ...
        <Box>
          ...
          <Alert severity="info" sx={{ mb: 3 }}>
            <Typography variant="body2">
              ...
              please go back and select an event package. Alternatively, you can request a custom
              quote and our team will help you build the perfect package for your event.
            </Typography>
          </Alert>
    ...
    <Box>
      ...
      {completionChoice === 'quote' && (
        <>
          ...
          <Alert severity="info" sx={{ mb: 3 }}>
            Tell us about your special requirements and we'll prepare a customized quote for you
            within 24 hours.
          </Alert>
          ...
          <Box sx={{ textAlign: 'center', mb: 2 }}>
            ...
            >
              Click &ldquo;
              {bookingState.quickQuoteMode ? 'Submit Quote Request' : 'Continue'}
                  ...
                  <Box sx={{ mt: 3 }}>
                    ...
                    <RadioGroup
                      ...
                      onChange={(e) => {
                        ...
                        if (gateway)
                          handleGatewaySelect(gateway as unknown as Record<string, unknown>);
                      }}
                    >
            ...
            >
              ...
              <Alert severity="success" sx={{ mb: 2 }}>
                ...
                <Typography variant="body2">
                  ...
                  You'll only be charged <strong>{amounts.formattedDueNow}</strong> after final
                  confirmation.
                </Typography>
              </Alert>
