        ...
        <DialogContent>
          ...
          >
            ...
            <Typography variant="body1" color="text.secondary" textAlign="center">
              {paymentSuccessMessage || 'Your payment has been processed successfully.'} You should
            ...
            <>
              <Stack spacing={3}>
                ...
                {!isLoadingPaymentSettings &&
                  (invoice.effective_payment_terms || globalPaymentSettings) && (
                    <Box>
                      ...
                      {isDepositAlreadyPaid && (
                        <Alert severity="info" sx={{ mb: 2 }}>
                          Deposit of {formatAmount(paymentAmounts.deposit, invoice.currency)} has
                          been paid. You can pay the remaining balance or a custom amount.
                        </Alert>
                      )}
                      ...
                      <RadioGroup
                        value={paymentType}
                        onChange={(e) =>
                          setPaymentType(e.target.value as 'FULL' | 'DEPOSIT' | 'CUSTOM')
                        }
                      >
                            ...
                            label={
                              <Box>
                                ...
                                >
                                  ...
                                  {formatAmount(paymentAmounts.remaining, invoice.currency)} due by{' '}
                      ...
                      {paymentType === 'CUSTOM' && (
                        <Alert severity="info" sx={{ mt: 1 }}>
                          <Typography variant="body2">
                            ...
                            . If you're not paying the full amount, you must leave at least this
