...
const colorPresets: ColorPreset[] = [
  { name: 'Ocean Blue', primary: '#1976d2', secondary: '#0288d1', preview: 'linear-gradient(45deg, #1976d2, #0288d1)' },
  ...
  { name: 'Arctic Blue', primary: '#0277bd', secondary: '#81d4fa', preview: 'linear-gradient(45deg, #0277bd, #81d4fa)' },
];
