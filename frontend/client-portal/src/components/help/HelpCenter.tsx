  ...
  const faqs: FAQ[] = [
    {
      ...
      answer: 'To book a new event, click on the "Book Event" button in your dashboard. You\'ll be guided through a step-by-step process including selecting your event type, date, venue, and services.',
      category: 'booking',
      helpful: 24,
    },
    {
      ...
      answer: 'Yes, you can modify certain aspects of your booking up to 48 hours before the event date. Changes may incur additional fees depending on the modifications.',
      category: 'booking',
      helpful: 18,
    },
    {
      ...
      answer: 'We accept various payment methods including credit cards, bank transfers, and PayPal. You can set up payment plans or pay in full through your booking dashboard.',
      category: 'payment',
      helpful: 32,
    },
    {
      ...
      answer: 'Cancellation policies vary by event type and timing. Please review your contract terms or contact our support team for specific cancellation procedures.',
      category: 'policies',
      helpful: 15,
    },
  ];
  ...
  const articles: HelpArticle[] = [
    {
      ...
      content: 'Learn the essential steps for planning your perfect event, from initial concept to execution.',
      category: 'guides',
                      ...
                      >
                        <CardContent sx={{ p: 3 }}>
                          <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 2 }}>
                            <Avatar sx={{ backgroundColor: alpha(theme.palette.info.main, 0.15), color: 'info.main' }}>
                              <GuideIcon />
                            </Avatar>
                            <Box sx={{ flex: 1 }}>
