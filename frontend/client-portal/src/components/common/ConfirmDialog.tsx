// frontend/client-portal/src/components/common/ConfirmDialog.tsx
...
interface ConfirmDialogContextType {
  ...
  confirmLeaveBooking: () => Promise<boolean>;
  confirmClearBooking: () => Promise<boolean>;
}
...
export const ConfirmDialogProvider: React.FC<ConfirmDialogProviderProps> = ({ children }) => {
  ...
  const confirmClearBooking = (): Promise<boolean> => {
    return confirm({
      title: 'Clear Booking?',
      message: 'This will clear all your booking information and start over. Are you sure?',
      type: 'warning',
      confirmText: 'Clear',
      cancelText: 'Cancel',
      confirmColor: 'warning',
