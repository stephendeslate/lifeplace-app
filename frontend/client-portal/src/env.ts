...
const envSchema = z.object({
  ...
  // Feature Flags
  VITE_ENABLE_PAYPAL: z.string().optional(),
  VITE_ENABLE_PAYMENT_PLANS: z.string().optional(),
  VITE_ENABLE_GUEST_BOOKING: z.string().optional(),
  VITE_ENABLE_PODCASTS: z.string().optional(),
  VITE_ENABLE_HELP_CENTER: z.string().optional(),
});
