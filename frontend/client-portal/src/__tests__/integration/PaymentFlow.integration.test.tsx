...
describe("Payment Flow Integration Tests", () => {
  beforeEach(() => {
    ...
    mockFinancialApi.calculateInvoicePaymentStatus.mockImplementation(
      (invoice) => ({
        status: invoice.status === "PAID" ? "FULLY_PAID" : "UNPAID",
        amountRemaining:
          invoice.status === "PAID" ? 0 : parseFloat(invoice.total_amount),
        amountPaid:
          invoice.status === "PAID" ? parseFloat(invoice.total_amount) : 0,
