...
export const GA4Events = {
  // Booking funnel
  bookingStarted: (eventType?: string) => trackEvent('booking_started', { event_type: eventType }),
  ...
  contactFormSubmitted: () => trackEvent('generate_lead', { method: 'contact_form' }),
  ...
  // Gallery
  galleryViewed: (category?: string) => trackEvent('gallery_view', { category }),

  galleryPhotoClicked: (params: { category?: string; venue_name?: string; source?: string }) =>
