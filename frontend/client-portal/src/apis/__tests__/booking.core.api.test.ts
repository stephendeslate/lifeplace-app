...
describe('BookingCoreApi', () => {
  ...
  describe('getAvailableFlows', () => {
    it('fetches all flows when no event type specified', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/bookingflow/public/flows/', { params: {} });
  ...
  describe('validateStepData', () => {
    it('validates step data without saving', async () => {
      ...
      const result = await BookingCoreApi.validateStepData('uuid-123', 1, { email: 'test@example.com' });
    ...
    it('returns validation errors', async () => {
      ...
      const result = await BookingCoreApi.validateStepData('uuid-123', 1, { email: 'invalid' });
  ...
  describe('calculatePricing', () => {
    ...
    it('includes venue additional hours', async () => {
      ...
      await BookingCoreApi.calculatePricing('uuid-123', undefined, { 'venue-1': 2 });
  ...
  describe('formatStepData', () => {
    it('formats introduction step data', () => {
      const result = BookingCoreApi.formatStepData('introduction', { acknowledged: 1 });
    ...
    it('formats review_booking step data', () => {
      const result = BookingCoreApi.formatStepData('review_booking', {
        terms_accepted: true,
