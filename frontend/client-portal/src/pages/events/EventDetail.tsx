...
const EventDetail: React.FC = () => {
  ...
  return (
    <Box sx={{ p: { xs: 2, sm: 3, md: 4 } }}>
        ...
        >
          <Box flex={1}>
            <Stack direction="row" alignItems="center" spacing={1} mb={1}>
              <IconButton onClick={handleBack} size="small" aria-label="Back to events">
                <BackIcon />
              </IconButton>
      ...
      {/* Preferences Dialog */}
      <Dialog open={preferencesDialogOpen} onClose={handlePreferencesClose} maxWidth="sm" fullWidth>
