...
export const DocumentsPage: React.FC = () => {
  ...
  const computedFilters = useMemo((): DocumentFilters => ({
    ...filters,
  ...
  const hasActiveFilters = (filters.types?.length || 0) > 0 || filters.eventId !== undefined || searchQuery;
                  ...
                  return (
                    <Chip
                      ...
                      sx={{
                        ...
                        '& .MuiChip-icon': { color: isActive ? undefined : config.color },
                      }}
                    />
                  );
                })}
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
              ...
              {eventOptions.length > 0 && (
                <TextField
                  ...
                  onChange={(e) => handleEventFilter(e.target.value ? Number(e.target.value) : undefined)}
                  sx={{ minWidth: 200 }}
                >
