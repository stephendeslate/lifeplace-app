...
export const ServicesSection: React.FC = () => {
  const services: ServiceInfo[] = [
    ...
    },
    {
      ...
      icon: <School sx={{ fontSize: 48, color: tokens.color.base.olive[600] }} />,
    },
  ];
        ...
        <Stack spacing={tokens.spacing.space[8]}>
          ...
          >
            {services.map((service, index) => (
              <AnimatedElement key={service.id} animation="slideUp" delay={200 + index * 100}>
                <ServiceCard role="article" aria-label={`${service.title} service`}>
