...
describe('ServicesSection', () => {
  ...
  it('renders Workshops service with correct content', () => {
    ...
    const workshopsDescription = screen.getByText(/discover new skills and grow your creativity/i);
  ...
  it('renders service cards with correct aria labels', () => {
    ...
    expect(screen.getByLabelText('Camps & Retreats service')).toBeInTheDocument();
  ...
  describe('Accessibility', () => {
    ...
    it('provides descriptive aria-labels for service cards', () => {
      ...
      const campsRetreatsCard = screen.getByLabelText('Camps & Retreats service');
