...
describe('SocialProofSection', () => {
  ...
  it('displays all four stats cards', () => {
    render(<SocialProofSection />);

    // Check for stat labels
    expect(screen.getByText('Events Hosted')).toBeInTheDocument();
    expect(screen.getByText('Successful Events')).toBeInTheDocument();
  ...
  it('displays correct stat values', () => {
    ...
    // Check for stat values (formatted numbers)
  ...
  it('displays testimonial quotes', () => {
    ...
    expect(screen.getByText(/LifePlace made our wedding day absolutely perfect/i)).toBeInTheDocument();
  ...
  it('uses proper semantic HTML structure', () => {
    ...
    const h2 = screen.getByRole('heading', { level: 2, name: 'Trusted by Hundreds of Families' });
    expect(h2).toBeInTheDocument();

    const h3 = screen.getByRole('heading', { level: 3, name: 'What Our Clients Say' });
