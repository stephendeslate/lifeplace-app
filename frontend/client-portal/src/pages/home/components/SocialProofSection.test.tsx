...
describe("SocialProofSection", () => {
  it("renders without crashing", () => {
    ...
    expect(
      screen.getByText("Trusted by Hundreds of Families"),
    ).toBeInTheDocument();
  });
  ...
  it("displays section heading and subtitle", () => {
    ...
    expect(
      screen.getByText(/Join the many satisfied clients/i),
    ).toBeInTheDocument();
  });
  ...
  it("displays testimonial quotes", () => {
    ...
    expect(
      screen.getByText(/Outstanding venue and exceptional service/i),
    ).toBeInTheDocument();
    expect(
      screen.getByText(/We've hosted three events here/i),
    ).toBeInTheDocument();
  });
  ...
  it("displays testimonial roles and event info", () => {
    ...
    expect(
      screen.getByText(/Corporate Event Coordinator/i),
    ).toBeInTheDocument();
  ...
  describe("Accessibility", () => {
    ...
    it("testimonial quotes are properly formatted", () => {
      ...
      const quote = screen.getByText(
        /LifePlace made our wedding day absolutely perfect/i,
      );
