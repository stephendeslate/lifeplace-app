...
const SupportPage: React.FC = () => {
  ...
  const { data: inquiries, isLoading: inquiriesLoading, error: inquiriesError } = useSupportInquiries();
  ...
  return (
    <>
      <SEO
        title="Support | LifePlace Alfonso"
        description="Get help and support for your LifePlace events."
        noIndex={true}
      />
      <Box>
        {/* Header */}
