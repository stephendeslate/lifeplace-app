// frontend/client-portal/src/pages/booking/BookingFlow/BookingComplete.tsx
...
/**
 * Booking completion page with glass morphism design.
 * Displays confirmation details, next steps, important info,
 * contact support, and navigation actions.
 */
    ...
    <Container maxWidth="md" sx={{ py: 8, position: 'relative' }}>
      ...
      <AnimatedElement animation="slideDown" delay={100}>
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          >
            Thank you for choosing LifePlace Alfonso. Your event has been successfully booked and
      ...
      <AnimatedElement animation="slideUp" delay={300}>
        <WhatsNextSection theme={theme} />
      </AnimatedElement>

      {/* Important Information */}
      <AnimatedElement animation="slideUp" delay={700}>
        <ImportantInfoSection theme={theme} />
      </AnimatedElement>

      {/* Contact Support */}
      <AnimatedElement animation="slideUp" delay={800}>
        <ContactSupportSection theme={theme} />
      </AnimatedElement>
...
// ---------------------------------------------------------------------------
// Sub-sections (kept in-file since they're tightly coupled to BookingComplete)
// ---------------------------------------------------------------------------
...
const WhatsNextSection: React.FC<SectionProps> = ({ theme }) => (
  <GlassCard
    variant="light"
    intensity="strong"
    sx={{
...
const ImportantInfoSection: React.FC<SectionProps> = ({ theme }) => (
  <GlassCard
    variant="light"
    intensity="medium"
    sx={{
      ...
      <Stack spacing={2}>
        <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-start' }}>
          ...
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              Your selected date has been reserved. Any changes must be made at least 14 days in
              advance.
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-start' }}>
          ...
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              Payment details and schedules will be outlined in your confirmation email. Flexible
        ...
        <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-start' }}>
          ...
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              Venue access details, parking information, and setup times will be coordinated with
...
const ContactSupportSection: React.FC<SectionProps> = (_props) => (
  <GlassCard
    variant="light"
    intensity="subtle"
    sx={{
...
const ActionButtons: React.FC<SectionProps> = ({ theme }) => (
  <Box
    sx={{
      display: 'flex',
      gap: 2,
