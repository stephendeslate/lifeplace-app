                ...
                <Box sx={{ display: 'flex', gap: 3, alignItems: 'flex-start' }}>
                  ...
                  <Box sx={{ flex: 1 }}>
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.6 }}>
                      You'll receive a detailed confirmation email within the next few minutes with
                      all your booking details, payment information, and important dates.
                    </Typography>
                    <Chip
              ...
              <AnimatedElement animation="slideRight" delay={500}>
                <Box sx={{ display: 'flex', gap: 3, alignItems: 'flex-start' }}>
                  ...
                  <Box sx={{ flex: 1 }}>
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.6 }}>
                      Our dedicated event coordinator will contact you within 24 hours to discuss
                      your requirements, answer questions, and begin personalizing your event
                      experience.
                    </Typography>
                    <Chip
              ...
              <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-start' }}>
                ...
                <Box>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Your selected date has been reserved. Any changes must be made at least 14 days
                    in advance.
                  </Typography>
                </Box>
              </Box>
