...
const AcceptInvitation: React.FC = () => {
  ...
  const handleInputChange =
    (field: keyof AcceptInvitationData) => (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        <Box sx={{ maxWidth: 500, textAlign: 'center' }}>
          <Alert severity="error" sx={{ mb: 3 }}>
            ...
            <Typography variant="body2">
              This invitation link is invalid, expired, or has already been used. Please contact
              LifePlace Alfonso if you believe this is an error.
            </Typography>
          </Alert>
                  ...
                  <Stack spacing={2}>
                    ...
                    <Box display="flex" alignItems="center" gap={2}>
                      ...
                      <Box>
                        ...
                        <Typography variant="body1" sx={{ fontWeight: 500 }}>
                          {formatPhilippinesTime(invitation.created_at, false, 'MMM d, yyyy')}
                        </Typography>
                      </Box>
                    </Box>
                  </Stack>
                ...
                <Stack spacing={3}>
                  ...
                  <Alert severity="info" sx={{ mt: 2 }}>
                    <Typography variant="body2">
                      ...
                      you'll be able to book events, manage your reservations, and communicate with
                      our team.
                    </Typography>
                  </Alert>
                </Stack>
