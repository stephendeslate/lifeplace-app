...
export const ActionCenterPage: React.FC = () => {
  ...
  const hasActiveFilters =
    filters.types.length > 0 || filters.eventId !== undefined || searchQuery;
              ...
              <Stack spacing={2}>
                ...
                <Box>
                  ...
                  <Stack direction="row" spacing={1} flexWrap="wrap" gap={1}>
                    {(Object.keys(ACTION_TYPE_CONFIGS) as ActionType[]).map(
                      (type) => {
                ...
                <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
                  ...
                  <TextField
                    ...
                    value={sortBy}
                    onChange={(e) =>
                      setSortBy(e.target.value as ActionCenterSortOption)
                    }
                    sx={{ minWidth: 200 }}
                    InputProps={{
                      startAdornment: (
