  ...
  const packages: PackageInfo[] = [
    {
      ...
      name: "Budget Package",
      description:
        "Our most affordable option for groups seeking basic outdoor venue rental.",
    ...
    },
    {
      ...
      name: "Basic Package",
      description:
        "A popular choice with comfortable accommodations and comprehensive amenities.",
      minimumParticipants: 80,
      tiers: [
    ...
    },
    {
      ...
      description:
        "Our comprehensive package with all facilities and premium amenities included.",
      minimumParticipants: 80,
      badge: "Staff Pick",
      tiers: [
    ...
    },
    {
      ...
      description:
        "Professional team-building experience with facilitation by our partner MZone Team Building.",
      minimumParticipants: 80,
      tiers: [
      ...
      notes: ["Partnered with MZone Team Building (www.mzoneteambuilding.com)"],
    },
    {
      id: "all-in-team-building",
      name: "All-In Team-Building Package",
      description:
        "Complete team-building solution with accommodations, meals, and professional facilitation.",
      minimumParticipants: 80,
      tiers: [
      ...
      notes: ["Partnered with MZone Team Building"],
    },
  ];
