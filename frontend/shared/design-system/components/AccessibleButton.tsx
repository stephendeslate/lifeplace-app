  ...
  return {
    ...
    ...(glass && {
      ...
      border: `1px solid ${isDark 
        ? designTokens.glass.dark.medium.border
        : designTokens.glass.light.medium.border}`,
    }),
    ...
    '&:hover': {
      ...
      boxShadow: elevated 
        ? designTokens.shadows.elevation.lg
        : designTokens.shadows.elevation.sm,
...
export const PrimaryButton: React.FC<Omit<AccessibleButtonProps, 'color'>> = (props: Omit<AccessibleButtonProps, 'color'>) => (
  <AccessibleButton color="primary" {...props} />
);

export const SecondaryButton: React.FC<Omit<AccessibleButtonProps, 'color'>> = (props: Omit<AccessibleButtonProps, 'color'>) => (
...
export const LoadingButton: React.FC<AccessibleButtonProps> = ({ loading = true, ...props }: AccessibleButtonProps) => (
  <AccessibleButton loading={loading} {...props} />
);
