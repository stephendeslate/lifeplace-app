...
describe('validatePhoneNumber', () => {
  // Valid PH formats
  it.each(['09123456789', '+639123456789', '9123456789', '+63 912 345 6789', '0912-345-6789'])(
  ...
  it.each(['+14155551234', '+442071234567', '+81312345678', '+61412345678', '+1 415 555 1234'])(
    'accepts valid international number: %s',
    (phone) => {
      expect(validatePhoneNumber(phone)).toBe(true);
    },
  );
