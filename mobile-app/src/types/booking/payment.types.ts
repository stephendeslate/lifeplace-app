...
/**
 * Payment plan settings from backend PUBLIC API
 * Matches PublicPaymentSettingsSerializer - only fields exposed to public endpoints
 * Used by booking flow to display deposit/refund info
 */
