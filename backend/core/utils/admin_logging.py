...
class AdminLoggingMixin:
    ...
    def delete_model(self, request, obj):
        ...
        log_admin_model_action(
            ...
            obj=obj,
            action='delete',
            change_message='Deleted from admin'
        )
...
def _determine_severity(model_name: str, action: str, changed_fields: Optional[List[str]]) -> str:
...
def _is_permission_change(model_name: str, changed_fields: Optional[List[str]]) -> bool:
    ...
    if model_lower in {'group', 'permission'}:
        return True
...
def _mask_sensitive_config(config: Dict) -> Dict:
    ...
    sensitive_keys = {
        ...
        'credential', 'auth', 'stripe', 'webhook'
    }
