...
def validate_request_data(
    data: dict[str, Any], required_fields: list[str] = None, optional_fields: list[str] = None
) -> dict[str, Any]:
    """
    ...
    Returns:
        dict: Validation result
    """
    result = {"is_valid": True, "messages": [], "cleaned_data": {}}
...
class AdminLoggingMiddleware:
    ...
    def _log_admin_request(self, request):
        ...
        if action in ("delete_selected", "delete") or "user" in request.path.lower() or "permission" in request.path.lower():
