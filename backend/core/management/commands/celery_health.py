...
class CeleryHealthMonitor:
    ...
    def check_broker_health(self):
        ...
        try:
            ...
            result["status"] = "error"
            result["error"] = f"Connection timeout: {e!s}"
    ...
    def check_worker_health(self):
        ...
        try:
            ...
            result["status"] = "error"
            result["error"] = f"Failed to inspect workers: {e!s}"
    ...
    def check_queue_health(self):
        ...
        try:
            ...
            result["status"] = "error"
            result["error"] = f"Failed to check queues: {e!s}"
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--broker-only", action="store_true", help="Check only broker health")
        parser.add_argument("--workers-only", action="store_true", help="Check only worker health")
        parser.add_argument("--queues-only", action="store_true", help="Check only queue health")
        parser.add_argument(
            "--exit-code", action="store_true", help="Exit with non-zero code if unhealthy (for use in health checks)"
        )
