...
class NoteSerializer(BasicNoteSerializer):
    ...
    class Meta(BasicNoteSerializer.Meta):
        fields = [*BasicNoteSerializer.Meta.fields, "content_type", "object_id", "content_type_name", "content_object_repr"]
        read_only_fields = [*BasicNoteSerializer.Meta.read_only_fields, "content_type_name", "content_object_repr"]
