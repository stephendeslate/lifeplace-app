...
from core.domains.notes.serializers import NoteSerializer, NoteCreateSerializer
...
class TestBasicNoteSerializer:
    ...
    def test_read_only_fields(self, user_factory, event_factory):
        ...
        serializer = BasicNoteSerializer(note, data={
            'id': 999999,
            'title': 'Updated Title',
...
class TestNoteSerializer:
    ...
    def test_serialization_includes_content_type_info(
    ...
    def test_inherited_fields_from_basic_serializer(
        self, user_factory, event_factory
    ):
...
class TestNoteCreateSerializer:
    ...
    def test_valid_create_with_event_content_type(
        self, user_factory, event_factory, request_factory
    ):
    ...
    def test_valid_create_with_client_alias(
    ...
    def test_is_client_visible_default_false(
        self, user_factory, event_factory, request_factory
    ):
