    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "redeemable-benefits/",
                    ClientVIPView.as_view({"get": "redeemable_benefits"}),
                    name="client-redeemable-benefits",
                ),
                path(
                    "redeem-benefit/", ClientVIPView.as_view({"post": "redeem_benefit"}), name="client-redeem-benefit"
                ),
            ]
        ),
    ),
