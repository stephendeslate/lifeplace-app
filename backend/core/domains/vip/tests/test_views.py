...
def tier_hierarchy():
    ...
    silver = VIPTier.objects.create(name="Silver", level=1, is_active=True, min_total_spent=Decimal("10000.00"))
...
class TestVIPSettingsViewSet:
    ...
    def test_update_settings_as_admin(self, authenticated_admin, vip_settings):
        ...
        response = authenticated_admin.patch(
            url, {"program_name": "Elite Program", "earning_points_enabled": True}, format="json"
        )
    ...
    def test_update_settings_as_client_forbidden(self, authenticated_client, vip_settings):
        ...
        url = reverse("vip:vip-settings")
        response = authenticated_client.patch(url, {"program_name": "Hacked"}, format="json")
    ...
    def test_create_settings_as_admin(self, authenticated_admin):
        ...
        response = authenticated_admin.post(
            url, {"program_name": "VIP Elite", "is_program_enabled": True}, format="json"
        )
...
class TestVIPTierViewSet:
    ...
    def test_create_tier_as_admin(self, authenticated_admin):
        ...
        response = authenticated_admin.post(
            url,
            {"name": "Platinum", "level": 3, "description": "Platinum tier benefits", "min_total_spent": "100000.00"},
            format="json",
        )
    ...
    def test_update_tier_as_admin(self, authenticated_admin, tier_hierarchy):
        ...
        response = authenticated_admin.patch(url, {"description": "Updated description"}, format="json")
...
class TestVIPBenefitViewSet:
    ...
    def test_create_benefit_as_admin(self, authenticated_admin, tier_hierarchy):
        ...
        response = authenticated_admin.post(
            url,
            {"tier": gold.pk, "benefit_type": "PERCENTAGE_DISCOUNT", "value": "15.00", "application_mode": "AUTOMATIC"},
            format="json",
        )
    ...
    def test_filter_benefits_by_tier(self, authenticated_admin, tier_hierarchy):
        ...
        standard, silver, gold = tier_hierarchy
        VIPBenefit.objects.create(tier=gold, benefit_type="PERCENTAGE_DISCOUNT", value=Decimal("10.00"), is_active=True)
        VIPBenefit.objects.create(tier=silver, benefit_type="FIXED_DISCOUNT", value=Decimal("100.00"), is_active=True)
...
class TestClientVIPStatusViewSet:
    ...
    def client_with_status(self, user_factory, tier_hierarchy):
        ...
        standard, silver, gold = tier_hierarchy
        client = user_factory(role="CLIENT", email="vip@example.com", first_name="John", last_name="Doe")
    ...
    def test_assign_tier_action(self, authenticated_admin, client_with_status, tier_hierarchy):
        ...
        response = authenticated_admin.post(url, {"tier_id": silver.pk, "reason": "Manual downgrade"}, format="json")
    ...
    def test_assign_tier_invalid_tier(self, authenticated_admin, client_with_status):
        ...
        url = reverse("vip:client-vip-status-assign-tier", kwargs={"pk": status_obj.pk})
        response = authenticated_admin.post(url, {"tier_id": 99999}, format="json")
    ...
    def test_award_points_action(self, authenticated_admin, client_with_status):
        ...
        response = authenticated_admin.post(url, {"points": 100, "description": "Welcome bonus"}, format="json")
    ...
    def test_award_points_invalid_amount(self, authenticated_admin, client_with_status):
        ...
        _, status_obj = client_with_status
        url = reverse("vip:client-vip-status-award-points", kwargs={"pk": status_obj.pk})
        response = authenticated_admin.post(url, {"points": -50, "description": "Invalid"}, format="json")
    ...
    def test_adjust_points_action(self, authenticated_admin, client_with_status):
        ...
        response = authenticated_admin.post(url, {"points": -100, "description": "Correction"}, format="json")
    ...
    def test_adjust_points_zero_rejected(self, authenticated_admin, client_with_status):
        ...
        _, status_obj = client_with_status
        url = reverse("vip:client-vip-status-adjust-points", kwargs={"pk": status_obj.pk})
        response = authenticated_admin.post(url, {"points": 0, "description": "No change"}, format="json")
    ...
    def test_tier_history_action(self, authenticated_admin, client_with_status, tier_hierarchy):
        ...
        VIPTierHistory.objects.create(
            client_vip_status=status_obj, from_tier=silver, to_tier=gold, reason="AUTOMATIC_UPGRADE"
        )
...
class TestVIPPointTransactionViewSet:
    ...
    def transactions(self, user_factory, tier_hierarchy):
        ...
        status_obj = ClientVIPStatus.objects.create(client=client, current_tier=standard, points_balance=200)
...
class TestClientVIPView:
    ...
    def test_redeem_benefit_creates_redemption(
        self, authenticated_client, client_with_vip, vip_settings, event_factory
    ):
        """Test redeem_benefit creates a redemption record."""
        client_user, status_obj, gold = client_with_vip
        redeem_benefit = VIPBenefit.objects.get(tier=gold, application_mode="REDEEMABLE")
        event = event_factory(client=client_user)

        url = reverse("vip:client-redeem-benefit")
        response = authenticated_client.post(
            url, {"benefit_id": redeem_benefit.pk, "event_id": event.pk}, format="json"
        )
    ...
    def test_redeem_benefit_deducts_points(self, authenticated_client, client_with_vip, vip_settings, event_factory):
        ...
        url = reverse("vip:client-redeem-benefit")
        authenticated_client.post(url, {"benefit_id": redeem_benefit.pk, "event_id": event.pk}, format="json")
    ...
    def test_redeem_benefit_invalid_benefit(self, authenticated_client, client_with_vip, vip_settings, event_factory):
        ...
        url = reverse("vip:client-redeem-benefit")
        response = authenticated_client.post(url, {"benefit_id": 99999, "event_id": event.pk}, format="json")

        assert response.status_code == status.HTTP_400_BAD_REQUEST

    def test_redeem_benefit_wrong_client_event(
        self, authenticated_client, client_with_vip, vip_settings, event_factory, user_factory
    ):
    ...
    def test_redeem_benefit_insufficient_points(
        self, authenticated_client, client_with_vip, vip_settings, event_factory
    ):
