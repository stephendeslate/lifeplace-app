...
class TestVIPSettingsSerializer:
    ...
    def test_deserialize_settings(self):
        ...
        serializer = VIPSettingsSerializer(
            settings,
            data={"program_name": "Elite Program", "earning_points_enabled": True, "points_per_currency_spent": "2.00"},
            partial=True,
        )
    ...
    def test_read_only_fields(self):
        ...
        settings = VIPSettings.get_settings()
        serializer = VIPSettingsSerializer(
            settings, data={"id": 999, "created_at": "2020-01-01T00:00:00Z"}, partial=True
        )
...
class TestVIPTierSerializer:
    ...
    def test_serialize_tier(self):
        ...
        tier = VIPTier.objects.create(
            name="Gold", level=2, description="Gold tier benefits", min_total_spent=Decimal("50000.00"), color="#FFD700"
        )
    ...
    def test_serialize_tier_with_benefits_and_members(self, user_factory):
        ...
        # Add benefits
        VIPBenefit.objects.create(tier=tier, benefit_type="PERCENTAGE_DISCOUNT", value=Decimal("10.00"), is_active=True)
        ...
        ClientVIPStatus.objects.create(client=client, current_tier=tier, status="ACTIVE")
...
class TestVIPTierListSerializer:
    ...
    def test_serialize_tier_list(self):
        ...
        tier = VIPTier.objects.create(name="Gold", level=2, color="#FFD700", is_default=False)
...
class TestVIPBenefitSerializer:
    ...
    def test_deserialize_percentage_discount_requires_value(self, gold_tier):
        ...
        serializer = VIPBenefitSerializer(
            data={
                "tier": gold_tier.id,
                "benefit_type": "PERCENTAGE_DISCOUNT",
                # Missing value
...
class TestClientVIPStatusSerializer:
    ...
    def client_status(self, user_factory, gold_tier):
        ...
        client = user_factory(email="john@example.com", first_name="John", last_name="Doe", role="CLIENT")
    ...
    def test_client_name_falls_back_to_email(self, user_factory, gold_tier):
        ...
        client = user_factory(email="noname@example.com", first_name="", last_name="", role="CLIENT")
        status = ClientVIPStatus.objects.create(client=client, current_tier=gold_tier)
...
class TestVIPPointTransactionSerializer:
    ...
    def test_serialize_transaction(self, user_factory):
        ...
        admin = user_factory(admin=True)
        tier = VIPTier.objects.create(name="Gold", level=2)
        status = ClientVIPStatus.objects.create(client=client, current_tier=tier, points_balance=500)
...
class TestVIPRewardRedemptionSerializer:
    ...
    def test_serialize_redemption(self, user_factory, event_factory):
        ...
        client = user_factory(role="CLIENT")
        status = ClientVIPStatus.objects.create(client=client, current_tier=tier)
...
class TestVIPTierHistorySerializer:
    ...
    def test_serialize_tier_history(self, user_factory):
        ...
        client = user_factory(role="CLIENT")
        admin = user_factory(admin=True)
        status = ClientVIPStatus.objects.create(client=client, current_tier=gold)
...
class TestClientVIPStatusPublicSerializer:
    ...
    def setup_tiers(self):
        ...
        silver = VIPTier.objects.create(
            name="Silver", level=1, min_total_spent=Decimal("10000.00"), min_completed_bookings=3
        )
    ...
    def test_serialize_public_status(self, user_factory, setup_tiers):
        ...
        VIPBenefit.objects.create(
            tier=silver, benefit_type="PERCENTAGE_DISCOUNT", value=Decimal("5.00"), is_active=True
        )
    ...
    def test_no_next_tier_at_highest_level(self, user_factory, setup_tiers):
        ...
        standard, silver, gold = setup_tiers
        client = user_factory(role="CLIENT")
        status = ClientVIPStatus.objects.create(client=client, current_tier=gold, total_spent=Decimal("100000.00"))
...
class TestAssignTierSerializer:
    ...
    def test_valid_tier_assignment(self):
        ...
        serializer = AssignTierSerializer(data={"tier_id": tier.id, "reason": "VIP customer request"})
    ...
    def test_invalid_tier_id(self):
        ...
        serializer = AssignTierSerializer(
            data={
...
class TestAwardPointsSerializer:
    ...
    def test_valid_award_points(self):
        ...
        serializer = AwardPointsSerializer(data={"points": 100, "description": "Welcome bonus"})
    ...
    def test_points_must_be_positive(self):
        ...
        serializer = AwardPointsSerializer(data={"points": 0, "description": "Test"})
    ...
    def test_negative_points_rejected(self):
        ...
        serializer = AwardPointsSerializer(data={"points": -50, "description": "Test"})
...
class TestAdjustPointsSerializer:
    ...
    def test_valid_positive_adjustment(self):
        ...
        serializer = AdjustPointsSerializer(data={"points": 50, "description": "Correction"})

        assert serializer.is_valid()

    def test_valid_negative_adjustment(self):
        """Test valid negative point adjustment."""
        serializer = AdjustPointsSerializer(data={"points": -50, "description": "Correction for error"})
    ...
    def test_zero_adjustment_rejected(self):
        ...
        serializer = AdjustPointsSerializer(data={"points": 0, "description": "No change"})
...
class TestRedeemBenefitSerializer:
    ...
    def test_valid_redemption(self, event_factory):
        ...
        serializer = RedeemBenefitSerializer(data={"benefit_id": benefit.id, "event_id": event.id})
    ...
    def test_invalid_benefit_id(self, event_factory):
        ...
        serializer = RedeemBenefitSerializer(data={"benefit_id": 99999, "event_id": event.id})
