...
class TestVIPTier:
    ...
    def test_create_tier(self):
        ...
        tier = VIPTier.objects.create(name="Gold", level=2, description="Gold tier benefits", color="#FFD700")
...
class TestVIPBenefit:
    ...
    def test_create_percentage_discount_benefit(self, gold_tier):
        ...
        benefit = VIPBenefit.objects.create(
            tier=gold_tier, benefit_type="PERCENTAGE_DISCOUNT", value=Decimal("10.00"), application_mode="AUTOMATIC"
        )
    ...
    def test_benefit_string_representation(self, gold_tier):
        ...
        benefit = VIPBenefit.objects.create(tier=gold_tier, benefit_type="PERCENTAGE_DISCOUNT", value=Decimal("10.00"))
    ...
    def test_benefit_name_property_with_display_name(self, gold_tier):
        ...
        benefit = VIPBenefit.objects.create(
            tier=gold_tier, benefit_type="PERCENTAGE_DISCOUNT", value=Decimal("10.00"), display_name="10% VIP Discount"
        )
    ...
    def test_benefit_name_property_without_display_name(self, gold_tier):
        ...
        benefit = VIPBenefit.objects.create(tier=gold_tier, benefit_type="FREE_HOURS", value=Decimal("2.00"))
    ...
    def test_benefit_usage_limits(self, gold_tier):
        ...
        benefit = VIPBenefit.objects.create(
            tier=gold_tier, benefit_type="WAIVE_SERVICE_CHARGE", max_uses_per_booking=1, max_uses_per_month=3
        )
    ...
    def test_benefit_ordering(self, gold_tier):
        ...
        benefit1 = VIPBenefit.objects.create(tier=gold_tier, benefit_type="FIXED_DISCOUNT", value=Decimal("100.00"))
        benefit2 = VIPBenefit.objects.create(tier=standard, benefit_type="PERCENTAGE_DISCOUNT", value=Decimal("5.00"))
...
class TestClientVIPStatus:
    ...
    def test_create_client_vip_status(self, client_user, standard_tier):
        ...
        status = ClientVIPStatus.objects.create(client=client_user, current_tier=standard_tier)
    ...
    def test_vip_status_string_representation(self, client_user, gold_tier):
        ...
        status = ClientVIPStatus.objects.create(client=client_user, current_tier=gold_tier)
    ...
    def test_vip_status_string_representation_no_tier(self, client_user):
        ...
        status = ClientVIPStatus.objects.create(client=client_user, current_tier=None)
    ...
    def test_is_vip_property_true(self, client_user, gold_tier):
        ...
        status = ClientVIPStatus.objects.create(client=client_user, current_tier=gold_tier, status="ACTIVE")
    ...
    def test_is_vip_property_false_for_default_tier(self, client_user, standard_tier):
        ...
        status = ClientVIPStatus.objects.create(client=client_user, current_tier=standard_tier, status="ACTIVE")
    ...
    def test_is_vip_property_false_for_expired_status(self, client_user, gold_tier):
        ...
        status = ClientVIPStatus.objects.create(client=client_user, current_tier=gold_tier, status="EXPIRED")
    ...
    def test_is_expired_property_true_for_past_expiration(self, client_user, gold_tier):
        ...
        status = ClientVIPStatus.objects.create(
            client=client_user, current_tier=gold_tier, status="ACTIVE", expires_at=timezone.now() - timedelta(days=1)
        )
    ...
    def test_is_expired_property_false_for_future_expiration(self, client_user, gold_tier):
        ...
        status = ClientVIPStatus.objects.create(
            client=client_user, current_tier=gold_tier, status="ACTIVE", expires_at=timezone.now() + timedelta(days=30)
        )
...
class TestVIPPointTransaction:
    ...
    def client_vip_status(self, user_factory):
        ...
        return ClientVIPStatus.objects.create(client=client, current_tier=tier, points_balance=500)
...
class TestVIPRewardRedemption:
    ...
    def test_redemption_string_representation(self, client_vip_status, redeemable_benefit, event_factory):
        """Test VIPRewardRedemption __str__ format."""
        event = event_factory(client=client_vip_status.client)
        redemption = VIPRewardRedemption.objects.create(
            client_vip_status=client_vip_status, benefit=redeemable_benefit, event=event, points_spent=100
        )

        expected = f"{client_vip_status.client.email} - {redeemable_benefit.name}"
        assert str(redemption) == expected

    def test_redemption_applied_status(self, client_vip_status, redeemable_benefit, event_factory):
...
class TestVIPTierHistory:
    ...
    def test_tier_history_string_representation(self, client_vip_status, standard_tier, gold_tier):
        """Test VIPTierHistory __str__ format."""
        history = VIPTierHistory.objects.create(
            client_vip_status=client_vip_status, from_tier=standard_tier, to_tier=gold_tier, reason="AUTOMATIC_UPGRADE"
        )
    ...
    def test_tier_history_initial_assignment(self, client_vip_status, gold_tier):
        ...
        history = VIPTierHistory.objects.create(
            client_vip_status=client_vip_status, from_tier=None, to_tier=gold_tier, reason="INITIAL"
        )

        expected = f"{client_vip_status.client.email}: None -> Gold"
        assert str(history) == expected

    def test_tier_history_with_admin(self, client_vip_status, standard_tier, gold_tier, user_factory):
    ...
    def test_tier_history_ordering(self, client_vip_status, standard_tier, gold_tier):
        ...
        history1 = VIPTierHistory.objects.create(
            client_vip_status=client_vip_status, from_tier=None, to_tier=standard_tier, reason="INITIAL"
        )
