...
class WorkflowStageSerializer(serializers.ModelSerializer):
    ...
    trigger_after_stage_name = serializers.CharField(source="trigger_after_stage.name", read_only=True, allow_null=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            "trigger_time",
            "trigger_after_stage",
            "trigger_after_stage_name",  # New field for delayed execution after another stage
            "email_template",
            "contract_template",
    ...
    def validate(self, data):
        ...
        if is_automated and automation_type:
            ...
            if template_field:
                template_val = data.get(
                    template_field, getattr(self.instance, template_field, None) if self.instance else None
                )
                if not template_val:
                    raise serializers.ValidationError(
                        {
