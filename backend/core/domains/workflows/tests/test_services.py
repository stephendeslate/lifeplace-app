...
class TestWorkflowStageService:
    ...
    def test_update_stage_reorder(self, event_type_factory):
        ...
        updated = WorkflowStageService.update_stage(stage3.id, {'order': 1})
    ...
    def test_reorder_stages(self, event_type_factory):
        ...
        stages = WorkflowStageService.reorder_stages(template.id, 'LEAD', order_mapping)
...
class TestWorkflowStageServiceEdgeCases:
    ...
    def test_reorder_only_affects_specified_stage_type(self, event_type_factory):
        ...
        lead_stage2 = WorkflowStage.objects.create(
            template=template,
            name='Lead 2',
            stage='LEAD',
            order=2
        ...
        order_mapping = {
            str(lead_stage1.id): 2,
            str(lead_stage2.id): 1
        }
