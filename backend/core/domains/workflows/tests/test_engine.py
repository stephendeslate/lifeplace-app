...
from core.domains.events.models import Event, EventType, EventTimeline
...
class TestWorkflowEngineAssignInitialWorkflow:
    ...
    def test_assign_initial_workflow_sets_first_lead_stage(
    ...
    def test_assign_initial_workflow_creates_timeline_entry(
        self, event_factory, event_type_factory
    ):
        ...
        timeline = EventTimeline.objects.filter(
            event=event,
    ...
    def test_assign_initial_workflow_executes_automation(
        self, event_factory, event_type_factory
    ):
    ...
    def test_assign_initial_workflow_with_quote_completion_type(
        self, event_factory, event_type_factory
    ):
    ...
    def test_assign_initial_workflow_executes_trigger_on_event_created(
        self, event_factory, event_type_factory
    ):
...
class TestWorkflowEngineProgressWorkflow:
    ...
    def test_progress_workflow_within_same_stage_type(
        self, event_factory, event_type_factory
    ):
    ...
    def test_progress_workflow_creates_timeline_entry(
        self, event_factory, event_type_factory
    ):
    ...
    def test_progress_workflow_cross_stage_type_lead_to_production(
        self, event_factory, event_type_factory
    ):
        ...
        lead_stage = WorkflowStage.objects.create(
            template=template,
            name='Lead Stage',
            stage='LEAD',
            order=1
    ...
    def test_progress_workflow_production_to_post_production(
        self, event_factory, event_type_factory
    ):
...
class TestWorkflowEngineTriggers:
    ...
    def test_payment_received_trigger_executes_automation(
        self, event_factory, event_type_factory
    ):
    ...
    def test_quote_accepted_trigger_executes_automation(
        self, event_factory, event_type_factory
    ):
        ...
        with patch('core.domains.notifications.services.NotificationService.create_notification') as mock_notify:
            result = WorkflowEngine.progress_workflow(event, trigger_type='QUOTE_ACCEPTED')
            mock_notify.assert_called_once()

    def test_contract_signed_trigger_executes_automation(
        self, event_factory, event_type_factory
    ):
        ...
        with patch('core.domains.notifications.services.NotificationService.create_notification') as mock_notify:
            result = WorkflowEngine.progress_workflow(event, trigger_type='CONTRACT_SIGNED')
            mock_notify.assert_called_once()

    def test_quote_sent_trigger_executes_automation(
        self, event_factory, event_type_factory
    ):
        ...
        with patch('core.domains.notifications.services.NotificationService.create_notification') as mock_notify:
            result = WorkflowEngine.progress_workflow(event, trigger_type='QUOTE_SENT')
            mock_notify.assert_called_once()

    def test_trigger_searches_all_workflow_stages(
        self, event_factory, event_type_factory
    ):
        ...
        trigger_stage = WorkflowStage.objects.create(
            template=template,
...
class TestWorkflowEngineAdvancementCriteria:
    ...
    def test_progress_blocked_by_progression_condition(
        self, event_factory, event_type_factory
    ):
...
class TestWorkflowEngineExecuteStageActions:
    ...
    def test_execute_stage_actions_immediate(
        self, event_factory, event_type_factory
    ):
    ...
    def test_execute_stage_actions_schedules_delayed_action(
        self, event_factory, event_type_factory
    ):
