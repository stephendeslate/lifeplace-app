...
class WorkflowAutomationTestCase(TestCase):
    ...
    def test_email_automation(self):
        ...
        with patch('core.domains.communications.services.CommunicationService.send_communication_by_template') as mock_send:
    ...
    def test_quote_automation_creates_quote(self):
        ...
        quote_template = QuoteTemplate.objects.create(
            name='Standard Quote',
            event_type=self.event_type,
            is_active=True
        )
...
class WorkflowTriggerAPITestCase(TestCase):
    ...
    def test_trigger_types(self):
        ...
        valid_types = [
            'PAYMENT_RECEIVED', 'PAYMENT_PLAN_CREATED', 'PAYMENT_OVERDUE',
            'QUOTE_ACCEPTED', 'CONTRACT_SIGNED', 'EVENT_CREATED',
            'EVENT_COMPLETED', 'TASK_COMPLETED', 'DATE_TRIGGER', 'MANUAL_TRIGGER'
        ]
