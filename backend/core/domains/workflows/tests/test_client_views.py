...
class ClientWorkflowProgressAPITestCase(TestCase):
    ...
    def test_get_event_progress_authenticated(self):
        ...
        response = self.api_client.get(
            f'/api/workflows/client/workflows/events/{self.event.id}/progress/'
        )
    ...
    def test_get_event_progress_no_workflow(self):
        ...
        response = self.api_client.get(
            f'/api/workflows/client/workflows/events/{event_no_workflow.id}/progress/'
        )
    ...
    def test_event_not_found(self):
        ...
        response = self.api_client.get(
            '/api/workflows/client/workflows/events/99999/progress/'
        )
