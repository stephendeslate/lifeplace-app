...
class TestVenueDetailSerializer:
    ...
    def test_includes_blocked_dates(self, venue_factory):
        ...
        VenueBlockedDate.objects.create(
            venue=venue,
            date=future_date,
            reason='Maintenance',
            is_full_day=True
...
class TestPackageVenueInlineSerializer:
    ...
    def test_operating_rules_only_for_primary(self, venue_factory, venue_operating_rules_factory, product_option_factory):
        ...
        pv_primary = PackageVenue.objects.create(
            package=package, venue=venue1, is_primary=True
        )
        pv_secondary = PackageVenue.objects.create(
            package=package, venue=venue2, is_primary=False
        )
