...
from core.factories.products import ProductCategoryFactory, ProductOptionFactory
...
def package_with_venues(product_option_factory, venue_factory, venue_operating_rules_factory):
    ...
    pv1 = PackageVenue.objects.create(package=package, venue=venue1, is_primary=True, access_order=1)
    pv2 = PackageVenue.objects.create(package=package, venue=venue2, is_primary=False, access_order=2)

    return {"package": package, "primary_venue": venue1, "secondary_venue": venue2, "package_venues": [pv1, pv2]}
