...
class VenueOperatingRulesInline(admin.StackedInline):
    ...
    fieldsets = (
        ("Check-in/Checkout", {"fields": ("default_check_in_time", "default_checkout_time", "checkout_next_day")}),
        (
            "Program Duration",
            {
                "fields": (
        ...
        (
            "Early Check-in",
            {"fields": ("early_checkin_allowed", "early_checkin_fee_per_hour", "earliest_checkin_time")},
        ),
        (
            "Late Checkout",
            {
        ...
        ("Custom Rules", {"fields": ("custom_rules",), "classes": ("collapse",)}),
    )
...
class VenueEventTypeConfigurationInline(admin.TabularInline):
    ...
    extra = 1
    fields = ("event_type", "included_hours", "base_price", "excess_hour_price", "is_all_day_access", "notes")
...
class VenueAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "code", "description", "is_overnight")}),
        ("Capacity", {"fields": ("minimum_capacity", "maximum_capacity", "recommended_capacity")}),
        ("Status", {"fields": ("is_active", "is_bookable", "is_featured")}),
        (
...
class VenueOperatingRulesAdmin(admin.ModelAdmin):
    ...
    list_filter = ("checkout_next_day", "is_fixed_duration", "early_checkin_allowed", "late_checkout_allowed")
    ...
    fieldsets = (
        ...
        ("Custom Rules", {"fields": ("custom_rules",)}),
    )


@admin.register(PackageVenue)
class PackageVenueAdmin(admin.ModelAdmin):
    list_display = ("package", "venue", "is_primary", "access_order", "access_duration_hours")
    ...
    fieldsets = (
        (None, {"fields": ("package", "venue")}),
        ("Configuration", {"fields": ("is_primary", "access_order", "access_duration_hours", "notes")}),
    )


@admin.register(VenueBlockedDate)
class VenueBlockedDateAdmin(admin.ModelAdmin):
    list_display = ("venue", "date", "reason", "is_full_day", "blocked_start_time", "blocked_end_time", "created_by")
    ...
    fieldsets = (
        (None, {"fields": ("venue", "date", "reason")}),
        ("Time Block", {"fields": ("is_full_day", "blocked_start_time", "blocked_end_time")}),
    )
...
class VenueEventTypeConfigurationAdmin(admin.ModelAdmin):
    ...
    list_display = ("venue", "event_type", "included_hours", "base_price", "excess_hour_price", "is_all_day_access")
    ...
    fieldsets = (
        (None, {"fields": ("venue", "event_type")}),
        (
            "Pricing Overrides",
            {
                "fields": ("base_price", "included_hours", "excess_hour_price", "is_all_day_access"),
