...
class ClientPaymentMethodViewSetTest(TestCase):
    ...
    def setUp(self):
        ...
        self.client_user = User.objects.create_user(
            email="client@test.com", password="test123", role="CLIENT", first_name="Test", last_name="Client"
        )

        self.admin_user = User.objects.create_user(
            email="admin@test.com", password="admin123", role="ADMIN", first_name="Admin", last_name="User"
        )
        ...
        self.gateway.config = {"secret_key": "sk_test_123", "publishable_key": "pk_test_123"}
...
class ClientInvoiceViewSetTest(TestCase):
    ...
    def setUp(self):
        ...
        self.event = Event.objects.create(
            client=self.client_user, event_type=self.event_type, name="Test Wedding", start_date=timezone.now()
        )
...
class ClientPaymentViewSetTest(TestCase):
    ...
    def setUp(self):
        """Set up test data"""
        self.client_user = User.objects.create_user(email="client@test.com", password="test123", role="CLIENT")
