...
from core.domains.payments.models import Invoice, Payment, PaymentGateway, PaymentMethod
...
class InvoicePaymentTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.client_user = User.objects.create_user(
            email="client@test.com", password="testpass123", first_name="Test", last_name="Client", role="CLIENT"
        )

        self.admin_user = User.objects.create_user(
            email="admin@test.com", password="testpass123", first_name="Test", last_name="Admin", role="ADMIN"
        )
    ...
    def test_client_cannot_see_other_client_invoices(self):
        ...
        other_client = User.objects.create_user(email="other@test.com", password="testpass123", role="CLIENT")
    ...
    def test_invoice_download_pdf(self):
        ...
        with patch(
            "core.domains.payments.pdf_service.PaymentReceiptPDFService.generate_invoice_receipt_pdf"
        ) as mock_pdf:
    ...
    def test_pay_invoice_success(self, mock_process_payment):
        ...
        data = {"gateway_code": "stripe", "payment_method_id": self.payment_method.id, "notes": "Test payment"}
