...
from core.domains.payments import signals
...
class TestPaymentGatewayCacheInvalidationSignals:
    ...
    def test_gateway_save_invalidates_cache(
        ...
        gateway = payment_gateway_factory()
...
class TestEventFinancialTotalsUpdate:
    ...
    @patch('core.domains.payments.signals.update_event_financial_totals')
    def test_payment_save_updates_event_totals(
        self, mock_update_totals, payment_factory, confirmed_event
    ):
    ...
    @patch('core.domains.payments.signals.update_event_financial_totals')
    def test_invoice_save_updates_event_totals(
        self, mock_update_totals, invoice_factory, confirmed_event
    ):
