...
from core.domains.payments.models import Invoice, Payment, PaymentGateway, PaymentMethod, PaymentSettings
...
class OverPaymentPreventionTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            email="overpayment@test.com", first_name="Test", last_name="User", role="CLIENT"
        )
        ...
        self.payment_method = PaymentMethod.objects.create(
            gateway=self.gateway, user=self.user, type="CREDIT_CARD", token_reference="pm_test_overpayment"
        )
    ...
    def test_invoice_service_prevents_overpayment(self):
        ...
        payment_data = {"payment_type": "FULL", "gateway_code": "stripe", "is_manual": True}
