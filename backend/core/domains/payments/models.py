...
class Payment(BaseModel):
    ...
    invoice = models.ForeignKey(
        "Invoice", on_delete=models.SET_NULL, null=True, blank=True, related_name="related_payments"
    )
...
class PaymentEventStore(BaseModel):
    ...
    # Payment context
    payment = models.ForeignKey("Payment", on_delete=models.CASCADE, related_name="stored_events")
...
class PaymentDispute(BaseModel):
    ...
    gateway = models.ForeignKey(
        PaymentGateway, on_delete=models.PROTECT, help_text="Payment gateway that reported the dispute"
    )
