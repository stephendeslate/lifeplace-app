...
class PaymentReceiptPDFService:
    ...
    def generate_receipt_pdf(payment):
        ...
        receipt_info_data = [
            ...
            [
                "Issue Date:",
                payment.receipt_generated_on.strftime("%B %d, %Y")
                if payment.receipt_generated_on
        ...
        event_info_data = [
            ...
            [
                "Event Date:",
                payment.event.start_date.strftime("%B %d, %Y") if payment.event.start_date else "Not scheduled",
            ],
        ]
        ...
        try:
            ...
            # Fallback formatting
            currency_symbol = (
                "₱" if payment.currency == "PHP" else "$" if payment.currency == "USD" else payment.currency + " "
            )
