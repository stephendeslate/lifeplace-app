...
class BookingFlowIntegrationTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.payment_gateway, _ = PaymentGateway.objects.get_or_create(
            code="stripe", defaults={"name": "Stripe Test", "is_active": True, "config": {}}
        )
    ...
    def test_authenticated_quote_request_completion(self):
        ...
        url = reverse("bookingflow:bookingsession-complete-booking", kwargs={"pk": self.session.id})

        data = {"completion_type": "quote"}
    ...
    def test_public_quote_request_completion(self):
        ...
        url = reverse(
            "bookingflow:publicbookingflow-complete-booking-public",
    ...
    def test_invalid_completion_type_validation(self):
        ...
        data = {"completion_type": "invalid_type"}
    ...
    def test_payment_step_configuration_serialization(self):
        ...
        url = reverse("bookingflow:bookingflowstep-detail", kwargs={"pk": self.payment_step.id})
