...
class PaymentQuoteFlowTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.addon, _ = ProductOption.objects.get_or_create(
            name="Extra Hour",
            category=self.category,
            defaults={"description": "Additional hour of service", "base_price": Decimal("200.00"), "type": "PRODUCT"},
        )
    ...
    def test_quote_request_validation_disabled(self):
        ...
        with self.assertRaises(Exception) as context:
            BookingSessionService.complete_booking(str(self.session.session_id), completion_type="quote")
