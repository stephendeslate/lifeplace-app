...
class TestDataAccess:
    ...
    def test_data_access_success(self, authenticated_client, user_factory):
        ...
        user = user_factory(email="test@example.com", first_name="John", last_name="Doe")
...
class TestAccountDeletion:
    ...
    def test_deletion_success(self, authenticated_client, user_factory):
        ...
        response = client.delete(url, {"confirmation": "DELETE MY ACCOUNT", "password": "TestPass123!"}, format="json")
    ...
    def test_deletion_wrong_password(self, authenticated_client, user_factory):
        ...
        url = reverse("users:account-deletion")
        response = client.delete(
            url, {"confirmation": "DELETE MY ACCOUNT", "password": "WrongPassword!"}, format="json"
        )
    ...
    def test_deletion_unauthenticated(self, api_client):
        ...
        response = api_client.delete(
            url, {"confirmation": "DELETE MY ACCOUNT", "password": "TestPass123!"}, format="json"
        )
...
class TestDataCorrection:
    ...
    def test_correction_success(self, authenticated_client, user_factory):
        ...
        response = client.patch(
            url,
            {"corrections": [{"field": "first_name", "current_value": "John", "corrected_value": "Jonathan"}]},
            format="json",
        )
    ...
    def test_correction_non_correctable_field(self, authenticated_client, user_factory):
        ...
        response = client.patch(
            url,
            {"corrections": [{"field": "role", "current_value": "CLIENT", "corrected_value": "ADMIN"}]},
            format="json",
        )
    ...
    def test_correction_unauthenticated(self, api_client):
        ...
        response = api_client.patch(
            url, {"corrections": [{"field": "first_name", "corrected_value": "Test"}]}, format="json"
        )
