...
class TestUserLoginAPI:
    ...
    def test_login_success(self, api_client, user_factory):
        ...
        response = api_client.post(url, {"email": "test@example.com", "password": "testpass123"})
    ...
    def test_login_with_remember_me(self, api_client, user_factory):
        ...
        url = reverse("users:login")
        response = api_client.post(url, {"email": "test@example.com", "password": "testpass123", "remember_me": True})
    ...
    def test_login_invalid_password(self, api_client, user_factory):
        ...
        url = reverse("users:login")
        response = api_client.post(url, {"email": "test@example.com", "password": "wrongpassword"})
...
class TestCurrentUserAPI:
    ...
    def test_update_current_user_with_profile(self, authenticated_client, user_factory):
        ...
        response = client.put(
            url,
            {"first_name": "Updated", "profile": {"phone": "+639123456789", "company": "New Company"}},
            format="json",
        )
...
class TestAdminInvitationAPI:
    ...
    def test_create_invitation_as_admin(self, admin_client, mocker):
        ...
        # Mock email sending
        mocker.patch("core.domains.users.services.AdminInvitationService._send_invitation_email")
    ...
    def test_accept_invitation(self, api_client, admin_invitation_factory):
        ...
        response = api_client.post(
            url, {"password": "NewPassword123!", "confirm_password": "NewPassword123!"}, format="json"
        )
