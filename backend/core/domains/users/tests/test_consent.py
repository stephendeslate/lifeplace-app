...
class TestConsentList:
    ...
    def test_list_consents_shows_granted_status(
        self, authenticated_client, user_factory, consent_record_factory
    ):
        ...
        marketing_consent = next(
            (c for c in response.data['consents'] if c['consent_type'] == 'MARKETING_EMAIL'),
            None
        )
...
class TestConsentWithdraw:
    ...
    def test_withdraw_creates_consent_record(
...
class TestPrivacyRequestList:
    ...
    def test_list_privacy_requests_with_records(
        self, authenticated_client, user_factory, privacy_request_factory
    ):
    ...
    def test_list_privacy_requests_structure(
        self, authenticated_client, user_factory, privacy_request_factory
    ):
    ...
    def test_list_privacy_requests_only_own(
        self, authenticated_client, user_factory, privacy_request_factory
    ):
    ...
    def test_list_privacy_requests_ordered_by_date(
        self, authenticated_client, user_factory, privacy_request_factory
    ):
