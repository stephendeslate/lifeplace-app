...
FULL_ADMIN_PERMISSIONS = dict.fromkeys(ADMIN_PERMISSIONS.keys(), True)
...
def validate_permissions(permissions_dict):
    ...
    return {key: bool(value) for key, value in permissions_dict.items() if key in ADMIN_PERMISSIONS}
