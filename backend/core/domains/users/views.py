...
from core.utils.permissions import CanManageAdmins, IsAdmin, IsOwnerOrAdmin
...
from core.utils.security_logging import SecurityEventType, SecurityLogger, security_logger
...
security_logger = SecurityLogger()  # noqa: F811
