...
class TestNotificationTypeSerializer:
    ...
    def test_read_only_fields(self, notification_type):
        ...
        serializer = NotificationTypeSerializer(notification_type, data={"created_at": timezone.now()}, partial=True)
        serializer.is_valid()
...
class TestNotificationPreferenceSerializer:
    ...
    def user(self):
        """Create a test user"""
        return User.objects.create_user(email="prefuser@example.com", password="testpass123", role="CLIENT")
    ...
    def test_update_preferences(self, preferences):
        ...
        serializer = NotificationPreferenceSerializer(preferences, data=update_data, partial=True)
        assert serializer.is_valid(), serializer.errors
...
class TestNotificationSerializer:
    ...
    def user(self):
        ...
        return User.objects.create_user(
            email="notifuser@example.com", password="testpass123", first_name="Test", last_name="User", role="CLIENT"
        )
    ...
    def test_can_mark_read_different_user(self, notification, notification_type):
        ...
        other_user = User.objects.create_user(email="other@example.com", password="testpass123", role="CLIENT")
...
class TestNotificationListSerializer:
    ...
    def user(self):
        """Create a test user"""
        return User.objects.create_user(email="listuser@example.com", password="testpass123", role="CLIENT")
    ...
    def test_serialization_includes_essential_fields(self, notification, user):
        ...
        serializer = NotificationListSerializer(notification, context={"request": request})
        data = serializer.data
...
class TestNotificationBulkActionSerializer:
    ...
    def user(self):
        """Create a test user"""
        return User.objects.create_user(email="bulkuser@example.com", password="testpass123", role="CLIENT")
...
class TestCreateNotificationSerializer:
    ...
    def users(self):
        """Create test users"""
        return [
            User.objects.create_user(email=f"recipient{i}@example.com", password="testpass123", role="CLIENT")
            for i in range(3)
        ]
...
class TestDevicePushTokenSerializer:
    ...
    def user(self):
        """Create a test user"""
        return User.objects.create_user(email="pushtoken@example.com", password="testpass123", role="CLIENT")
    ...
    def test_read_only_fields(self, push_token):
        """Test read-only fields are not writable"""
        serializer = DevicePushTokenSerializer(push_token, data={"failure_count": 999}, partial=True)
        serializer.is_valid()
...
class TestTestPushNotificationSerializer:
    ...
    def test_defaults(self):
        ...
        assert (
            "test" in serializer.validated_data.get("body", "").lower()
            or serializer.validated_data.get("body") == "This is a test push notification from LifePlace."
        )
...
class TestNotificationDigestSerializer:
    ...
    def user(self):
        """Create a test user"""
        return User.objects.create_user(
            email="digestser@example.com", password="testpass123", first_name="Digest", last_name="User", role="CLIENT"
        )
