...
class NotificationMetricsTestCase(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(email="metrics@example.com", password="testpass123", role="ADMIN")

        self.user2 = User.objects.create_user(email="metrics2@example.com", password="testpass123", role="CLIENT")
...
class NotificationAlertsTestCase(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(email="alerts@example.com", password="testpass123", role="ADMIN")
