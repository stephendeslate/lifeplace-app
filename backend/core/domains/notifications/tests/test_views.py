...
class TestNotificationViewSet:
    ...
    def test_mark_all_read_action(self, api_client, client_user, notifications):
        ...
        unread_count = Notification.objects.filter(
            recipient=client_user, is_read=False
        ).count()
    ...
    def test_create_notification_admin(
        self, mock_record, mock_check, mock_bulk_record, mock_bulk_check,
        api_client, admin_user, client_user, notification_type
    ):
