...
class NotificationMetrics:
    ...
    def get_delivery_stats(cls, hours: int = 24) -> Dict[str, Any]:
        ...
        if stats is None:
            ...
            try:
                ...
                logger.warning(f"Could not calculate average delivery time: {str(e)}")
    ...
    def get_category_breakdown(cls, hours: int = 24) -> Dict[str, Any]:
        ...
        if breakdown is None:
            ...
            category_data = Notification.objects.filter(
    ...
    def get_user_engagement_stats(cls, hours: int = 24) -> Dict[str, Any]:
        ...
        if stats is None:
            ...
            try:
                ...
                logger.warning(f"Could not calculate average time to read: {str(e)}")
    ...
    def get_system_health(cls) -> Dict[str, Any]:
        ...
        if health is None:
            try:
                ...
                stuck_notifications = recent_notifications.filter(
                    delivery_attempts={}
                ).count()
    ...
    def clear_cache(cls):
        ...
        try:
            ...
            logger.error(f"Failed to clear metrics cache: {str(e)}")
...
class NotificationAlerts:
    ...
    @classmethod
    def check_delivery_failures(cls, threshold: float = 0.2) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Failed to check delivery failures: {str(e)}")
        
        return None
    
    @classmethod
    def check_stuck_notifications(cls, max_stuck: int = 50) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            stuck_count = Notification.objects.filter(
            ...
            logger.error(f"Failed to check stuck notifications: {str(e)}")
