...
class TestUserBasicSerializer:
    ...
    def test_serialize_user(self, user_factory):
        ...
        user = user_factory(first_name="John", last_name="Doe", email="john@example.com", role="CLIENT")
...
class TestMessageAttachmentSerializer:
    ...
    def test_serialize_attachment(self, message_attachment_factory):
        ...
        attachment = message_attachment_factory(filename="document.pdf", file_size=1024, file_type="application/pdf")
...
class TestMessageSerializer:
    ...
    def test_serialize_message_with_attachments(self, message_factory, message_attachment_factory, request_context):
...
class TestMessageCreateSerializer:
    ...
    def test_create_internal_note_admin_only(self, message_thread_factory, user_factory, request_context):
    ...
    def test_admin_can_create_internal_note(self, message_thread_factory, user_factory, request_context):
...
class TestMessageThreadListSerializer:
    ...
    def test_unread_count_for_user(self, message_thread_factory, message_factory, user_factory, request_context):
    ...
    def test_last_message_preview(self, message_thread_factory, message_factory, request_context):
    ...
    def test_last_message_preview_truncation(self, message_thread_factory, message_factory, request_context):
    ...
    def test_can_manage_for_admin(self, message_thread_factory, user_factory, request_context):
    ...
    def test_can_manage_for_thread_owner(self, message_thread_factory, user_factory, request_context):
    ...
    def test_can_manage_for_other_client(self, message_thread_factory, user_factory, request_context):
...
class TestMessageThreadDetailSerializer:
    ...
    def test_serialize_thread_detail_includes_messages(self, message_thread_factory, message_factory, request_context):
    ...
    def test_messages_ordered_by_created_at(self, message_thread_factory, message_factory, request_context):
        """Test messages are ordered chronologically."""
        thread = message_thread_factory()
        message_factory(thread=thread, content="First")
        message_factory(thread=thread, content="Second")
    ...
    def test_admin_sees_internal_notes(self, message_thread_factory, message_factory, user_factory, request_context):
...
class TestMessageThreadUpdateSerializer:
    ...
    def test_update_thread_status(self, message_thread_factory, user_factory, request_context):
        ...
        serializer = MessageThreadUpdateSerializer(thread, data=data, partial=True, context=context)
        assert serializer.is_valid(), serializer.errors

        updated_thread = serializer.save()
        assert updated_thread.status == "resolved"

    def test_update_thread_priority(self, message_thread_factory, user_factory, request_context):
    ...
    def test_update_thread_assigned_admin(self, message_thread_factory, user_factory, request_context):
    ...
    def test_only_admin_can_update_thread(self, message_thread_factory, user_factory, request_context):
...
class TestMessageReadStatusSerializer:
    ...
    def test_read_status_user_info(self, message_factory, user_factory, request_context):
