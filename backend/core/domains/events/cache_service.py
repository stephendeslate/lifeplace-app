...
class EventCacheService:
    ...
    @classmethod
    def get_event_detail(cls, event_id: int) -> dict | None:
        """
    ...
    @classmethod
    def get_workflow_progress(cls, event_id: int) -> float | None:
        """
    ...
    @classmethod
    def get_cached_queryset(cls, key: str) -> list | None:
        """
    ...
    @classmethod
    def get_cached_event_list(cls, filters: dict) -> list[int] | None:
        """
    ...
    def warm_cache_for_event(cls, event_id: int) -> None:
        ...
        try:
            event = (
                Event.objects.select_related("client", "event_type", "workflow_template", "current_stage")
                .prefetch_related("tasks", "event_products", "timeline", "files")
                .get(id=event_id)
            )
    ...
    @classmethod
    def get_cached_event_types(cls, active_only: bool = True) -> list[dict] | None:
        """
    ...
    @classmethod
    def get_client_event_stats(cls, client_id: int) -> dict | None:
        """
