...
class EventTypeAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "description", "is_active", "color")}),
        (
            "Images",
            {
...
class EventAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("id", "name", "client", "event_type", "status")}),
        ("Date Information", {"fields": ("start_date", "end_date", "last_contacted")}),
        (
            "Financial Information",
            {"fields": ("total_price", "payment_status", "total_amount_due", "total_amount_paid")},
        ),
        ("Workflow", {"fields": ("workflow_template", "current_stage")}),
        ("Additional Details", {"fields": ("lead_source", "preferences")}),
    )
    readonly_fields = (
        "id",
        "total_amount_paid",
