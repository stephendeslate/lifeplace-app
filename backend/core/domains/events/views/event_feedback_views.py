...
class EventFeedbackViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        feedback = EventFeedbackService.create_feedback(serializer.validated_data, request.user)
    ...
    def respond(self, request, pk=None):
        ...
        feedback = EventFeedbackService.add_response(pk, response_text, request.user)
