...
class EventFileViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        file = EventFileService.create_file(serializer.validated_data, file_obj, request.user)

        return Response(self.get_serializer(file, context={"request": request}).data, status=status.HTTP_201_CREATED)
    ...
    def update(self, request, *args, **kwargs):
        ...
        file = EventFileService.update_file(instance.id, serializer.validated_data, file_obj, request.user)
