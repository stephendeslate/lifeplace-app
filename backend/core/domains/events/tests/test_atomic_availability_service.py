...
class TestValidateAndReserveDate:
    ...
    def test_reserve_available_date_success(self, test_date, booking_session_id):
        ...
        result = AtomicAvailabilityService.validate_and_reserve_date(
            event_date=test_date, booking_session_id=booking_session_id
        )
        ...
        reservation = DateReservation.objects.filter(token=result["reservation_token"]).first()
        assert reservation is not None
        assert reservation.status == "PENDING"
        assert reservation.booking_session_id == booking_session_id

    def test_reserve_returns_existing_reservation_for_same_session(self, test_date, booking_session_id):
        ...
        count = DateReservation.objects.filter(target_date=test_date, status="PENDING").count()
        assert count == 1

    def test_reserve_blocked_by_existing_event(self, test_date, booking_session_id, event_factory):
    ...
    def test_reserve_blocked_by_other_session_reservation(
        ...
        result1 = AtomicAvailabilityService.validate_and_reserve_date(
            event_date=test_date, booking_session_id=another_booking_session_id
        )
    ...
    def test_reserve_with_datetime_input(self, booking_session_id):
        ...
        result = AtomicAvailabilityService.validate_and_reserve_date(
            event_date=test_datetime, booking_session_id=booking_session_id
        )
    ...
    def test_reserve_with_custom_timeout(self, test_date, booking_session_id):
        ...
        result = AtomicAvailabilityService.validate_and_reserve_date(
            event_date=test_date, booking_session_id=booking_session_id, timeout_seconds=custom_timeout
        )
...
class TestConfirmReservation:
    ...
    def test_confirm_pending_reservation_success(self, test_date, booking_session_id, event_factory):
    ...
    def test_confirm_already_confirmed_is_idempotent(self, test_date, booking_session_id, event_factory):
    ...
    def test_confirm_released_reservation_fails(self, test_date, booking_session_id, event_factory):
...
class TestValidateReservationForCompletion:
    ...
    def test_valid_pending_reservation(self, test_date, booking_session_id):
        ...
        result = AtomicAvailabilityService.validate_reservation_for_completion(token, booking_session_id)

        assert result["valid"] is True
        assert result["error"] is None
        assert result["reservation"] is not None

    def test_validation_fails_for_different_session(self, test_date, booking_session_id, another_booking_session_id):
        ...
        result = AtomicAvailabilityService.validate_reservation_for_completion(token, another_booking_session_id)
    ...
    def test_validation_fails_for_nonexistent_reservation(self, booking_session_id):
        ...
        result = AtomicAvailabilityService.validate_reservation_for_completion(fake_token, booking_session_id)

        assert result["valid"] is False
        assert "not found" in result["error"].lower()

    def test_validation_fails_for_released_reservation(self, test_date, booking_session_id):
    ...
    def test_validation_fails_for_expired_reservation(self, test_date, booking_session_id):
...
class TestCleanupExpiredReservations:
    ...
    def test_cleanup_returns_zero_when_no_expired(self, test_date, booking_session_id):
        ...
        AtomicAvailabilityService.validate_and_reserve_date(event_date=test_date, booking_session_id=booking_session_id)
