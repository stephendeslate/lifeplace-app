...
class TestClientEventList:
    ...
    def test_list_returns_own_events_only(self, authenticated_client, event_factory, user_factory):
    ...
    def test_list_filter_by_status(self, authenticated_client, client_with_events):
    ...
    def test_list_filter_upcoming_only(self, authenticated_client, user_factory, event_factory):
...
class TestClientEventRetrieve:
    ...
    def test_retrieve_own_event(self, authenticated_client, user_factory, event_factory):
    ...
    def test_cannot_retrieve_other_client_event(self, authenticated_client, user_factory, event_factory):
    ...
    def test_retrieve_returns_detail_serializer(self, authenticated_client, user_factory, event_factory):
...
class TestClientEventTimeline:
    ...
    def test_timeline_returns_public_entries_only(self, authenticated_client, user_factory, event_factory):
...
class TestClientEventDocuments:
    ...
    def test_documents_returns_public_files_only(self, authenticated_client, user_factory, event_factory):
...
class TestClientEventTasks:
    ...
    def test_tasks_returns_visible_tasks_only(self, authenticated_client, user_factory, event_factory):
    ...
    def test_update_task_requires_client_input(self, authenticated_client, user_factory, event_factory):
        ...
        api = authenticated_client(client_user)
        response = api.patch(
            f"/api/client/events/{event.id}/tasks/{task.id}/", {"status": "COMPLETED", "completion_notes": "Done"}
        )
    ...
    def test_cannot_update_task_not_requiring_input(self, authenticated_client, user_factory, event_factory):
        ...
        api = authenticated_client(client_user)
        response = api.patch(f"/api/client/events/{event.id}/tasks/{task.id}/", {"status": "COMPLETED"})
...
class TestClientEventPreferences:
    ...
    def test_update_preferences(self, authenticated_client, user_factory, event_factory):
...
class TestClientEventFileUpload:
    ...
    def test_upload_file(self, authenticated_client, user_factory, event_factory):
        """Test client can upload files."""
        client_user = user_factory(role="CLIENT")
        event = event_factory(client=client_user)

        test_file = SimpleUploadedFile("document.pdf", b"file content", content_type="application/pdf")
...
class TestClientEventFeedback:
    ...
    def test_submit_feedback_completed_event(self, authenticated_client, user_factory, event_factory):
    ...
    def test_cannot_submit_feedback_non_completed(self, authenticated_client, user_factory, event_factory):
    ...
    def test_cannot_submit_duplicate_feedback(self, authenticated_client, user_factory, event_factory):
    ...
    def test_get_existing_feedback(self, authenticated_client, user_factory, event_factory):
    ...
    def test_update_feedback_without_response(self, authenticated_client, user_factory, event_factory):
    ...
    def test_cannot_update_feedback_with_response(self, authenticated_client, user_factory, event_factory):
...
class TestClientEventRebooking:
    ...
    def test_rebookable_events_list(self, authenticated_client, user_factory, event_factory):
    ...
    def test_rebook_info(self, authenticated_client, user_factory, event_factory):
    ...
    def test_rebook_event(self, authenticated_client, user_factory, event_factory):
        ...
        with patch("core.domains.events.services.rebook_service.EventRebookService.can_rebook") as mock_can:
    ...
    def test_rebook_not_allowed(self, authenticated_client, user_factory, event_factory):
...
class TestClientSelfCheckIn:
    ...
    def test_self_check_in_success(self, authenticated_client, user_factory, event_factory):
    ...
    def test_self_check_in_not_confirmed(self, authenticated_client, user_factory, event_factory):
    ...
    def test_self_check_in_already_checked_in(self, authenticated_client, user_factory, event_factory):
    ...
    def test_self_check_in_wrong_day(self, authenticated_client, user_factory, event_factory):
...
class TestClientNotes:
    ...
    def test_get_notes_returns_client_visible(self, authenticated_client, user_factory, event_factory):
    ...
    def test_create_note(self, authenticated_client, user_factory, event_factory):
    ...
    def test_create_note_requires_content(self, authenticated_client, user_factory, event_factory):
...
class TestClientDocumentDownload:
    ...
    def test_download_public_document(self, authenticated_client, user_factory, event_factory):
        ...
        api = authenticated_client(client_user)
        response = api.get(f"/api/client/events/{event.id}/documents/{event_file.id}/download/")

        assert response.status_code == status.HTTP_200_OK

    def test_cannot_download_private_document(self, authenticated_client, user_factory, event_factory):
