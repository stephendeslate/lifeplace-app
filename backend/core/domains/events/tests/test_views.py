...
class TestEventTypeViewSet:
    ...
    def test_update_event_type_admin_only(
        self, authenticated_admin, event_type_factory
    ):
    ...
    def test_delete_event_type_in_use_soft_delete(
        self, authenticated_admin, event_type_factory, event_factory
    ):
...
class TestEventViewSet:
    ...
    def test_list_events_filter_by_client(
        self, authenticated_admin, event_factory, user_factory
    ):
    ...
    def test_list_events_filter_by_date_range(
        self, authenticated_admin, event_factory
    ):
    ...
    def test_retrieve_event_uses_cache(
        self, mock_set, mock_get, authenticated_admin, event_factory
    ):
    ...
    def test_create_event(
        self, authenticated_admin, user_factory, event_type_factory
    ):
    ...
    def test_update_status_action_missing_status(
        self, authenticated_admin, event_factory
    ):
    ...
    def test_checkout_action(self, authenticated_admin, event_factory):
        ...
        with patch(
            'core.domains.events.services.CheckInService.checkout'
        ) as mock_checkout:
    ...
    def test_no_show_action(self, authenticated_admin, event_factory):
        ...
        with patch(
            'core.domains.events.services.CheckInService.mark_no_show'
        ) as mock_no_show:
    ...
    def test_place_hold_action(self, authenticated_admin, event_factory):
        ...
        with patch(
            'core.domains.events.services.DateHoldingService.place_temporary_hold'
        ) as mock_hold:
    ...
    def test_extend_hold_action(self, authenticated_admin, event_factory):
        ...
        with patch(
            'core.domains.events.services.DateHoldingService.extend_hold'
        ) as mock_extend:
    ...
    def test_release_hold_action(self, authenticated_admin, event_factory):
        ...
        with patch(
            'core.domains.events.services.DateHoldingService.release_hold'
        ) as mock_release:
    ...
    def test_hold_status_action(self, authenticated_admin, event_factory):
        ...
        with patch(
            'core.domains.events.services.DateHoldingService.get_hold_status'
        ) as mock_status:
...
class TestDateAvailabilityAPIView:
    ...
    def test_check_availability_with_blocked_date(
        self, authenticated_admin, event_factory, clear_cache
    ):
...
class TestPublicEventAvailabilityAPIView:
    ...
    def test_public_availability_returns_blocked_dates(
