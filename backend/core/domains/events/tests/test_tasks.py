...
class TestScheduleDeadlineReminders:
    ...
    def test_schedule_reminders_for_upcoming_deadlines(self, event_factory):
        ...
        with patch("core.domains.events.tasks.send_deadline_reminder.delay") as mock_delay:
...
class TestExpireDateHolds:
    ...
    def test_expire_temporary_holds(self, event_factory):
        ...
        with patch("core.domains.events.services.date_holding_service.DateHoldingService.release_hold") as mock_release:
            with patch("core.domains.events.tasks.send_hold_expired_notification.delay") as mock_notify:
...
class TestSendHoldExpiringSoonReminders:
    ...
    def test_schedule_reminders_for_expiring_holds(self, event_factory):
        ...
        with patch("core.domains.events.tasks.send_hold_expiring_reminder.delay") as mock_delay:
...
class TestScheduleEventDateReminders:
    ...
    def test_schedule_reminders(self, event_factory, user_factory):
        ...
        with patch("core.domains.events.tasks.send_event_date_reminder.delay"):
