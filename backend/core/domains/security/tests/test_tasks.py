...
class TestCheckNotificationDeadlinesTask:
    ...
    def test_no_breaches_pending_notification(self, mocker):
        ...
        mock_alert = mocker.patch("core.domains.security.tasks.send_deadline_alert.delay")
...
class TestSendDailyBreachSummaryTask:
    ...
    def test_summary_no_recipients_configured(self, settings, mocker):
        ...
        assert len(mail.outbox) == 0
        mock_logger.warning.assert_called_once_with("No recipients configured for daily breach summary")
