...
class SecurityBreachAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Identification", {"fields": ("breach_id", "title", "description")}),
        ("Classification", {"fields": ("breach_type", "severity", "status")}),
        (
            "Timeline",
        ...
        ("Root Cause Analysis", {"fields": ("attack_vector", "vulnerabilities_exploited"), "classes": ("collapse",)}),
        (
            "Response",
            {"fields": ("containment_actions", "remediation_steps", "prevention_measures"), "classes": ("collapse",)},
        ),
        ("NPC Notification", {"fields": ("npc_notified", "npc_notified_at", "npc_reference_number")}),
        ("User Notification", {"fields": ("users_notified", "users_notified_at")}),
        ("Assignment", {"fields": ("incident_lead",)}),
...
class SecurityEventAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Event Details", {"fields": ("timestamp", "event_type", "severity", "description")}),
        ("User Information", {"fields": ("user", "username", "user_agent")}),
        ("Network Information", {"fields": ("ip_address", "country")}),
        ("Request Information", {"fields": ("request_method", "request_path", "referer"), "classes": ("collapse",)}),
        ("Risk Assessment", {"fields": ("risk_score", "is_blocked", "details"), "classes": ("collapse",)}),
    )
