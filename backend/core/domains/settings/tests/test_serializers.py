...
class TestAppSettingsSerializer:
    ...
    def test_serialize_app_setting(self):
        ...
        setting = AppSettings.objects.create(
            category="SYSTEM", key="test_key", value={"test": True}, description="Test description"
        )
...
class TestCurrencySettingsCreateSerializer:
    ...
    def test_create_with_default_enabled_currencies(self):
        ...
        serializer = CurrencySettingsCreateSerializer(
            data={
...
class TestCurrencySettingsUpdateSerializer:
    ...
    def test_partial_update_allowed(self):
        ...
        serializer = CurrencySettingsUpdateSerializer(data={"decimal_places": 2})
...
class TestSystemCurrencySettingsSerializer:
    ...
    def test_valid_system_settings(self):
        ...
        serializer = SystemCurrencySettingsSerializer(
            data={
                "default_currency": "PHP",
                "enabled_currencies": ["PHP", "USD"],
                "display_format": "symbol",
    ...
    def test_invalid_currency_choice(self):
        ...
        serializer = SystemCurrencySettingsSerializer(data={"default_currency": "INVALID"})
    ...
    def test_validate_enabled_currencies(self):
        ...
        serializer = SystemCurrencySettingsSerializer(data={"enabled_currencies": ["PHP", "INVALID"]})
    ...
    def test_cross_field_validation(self):
        ...
        serializer = SystemCurrencySettingsSerializer(
            data={"default_currency": "EUR", "enabled_currencies": ["PHP", "USD"]}
        )
...
class TestLegalDocumentSerializer:
    ...
    def test_last_updated_by_name_with_user(self, user_factory):
        ...
        doc = LegalDocument.objects.create(document_type="PRIVACY_POLICY", last_updated_by=user)
    ...
    def test_last_updated_by_name_without_user(self):
        ...
        doc = LegalDocument.objects.create(document_type="TERMS_OF_SERVICE", last_updated_by=None)
...
class TestLegalDocumentUpdateSerializer:
    ...
    def test_valid_update_data(self):
        ...
        serializer = LegalDocumentUpdateSerializer(
            data={"title": "Updated Title", "content": "<p>Updated content</p>", "version": "2.0", "is_published": True}
        )
    ...
    def test_version_required(self):
        ...
        serializer = LegalDocumentUpdateSerializer(data={"version": ""})
    ...
    def test_partial_update(self):
        ...
        serializer = LegalDocumentUpdateSerializer(data={"is_published": True}, partial=True)
...
class TestPublicLegalDocumentSerializer:
    ...
    def test_all_fields_read_only(self):
        ...
        serializer = PublicLegalDocumentSerializer(data={"title": "Hacked Title"})
...
class TestCompanySettingsSerializer:
    ...
    def test_full_address_computed(self):
        ...
        settings = CompanySettings.objects.create(
            address_line1="123 Main St", city="Alfonso", province="Cavite", postal_code="4123", country="Philippines"
        )
    ...
    def test_partial_update(self):
        ...
        settings = CompanySettings.objects.create(company_name="Original Name")

        serializer = CompanySettingsSerializer(settings, data={"company_name": "Updated Name"}, partial=True)
...
class TestPublicCompanySettingsSerializer:
    ...
    def test_full_address_in_public(self):
        ...
        settings = CompanySettings.objects.create(
            address_line1="456 Public Ave", city="Metro Manila", province="NCR", country="Philippines"
        )
