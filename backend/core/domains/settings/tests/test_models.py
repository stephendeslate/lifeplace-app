...
class TestAppSettingsModel:
    ...
    def test_app_setting_string_representation_system_wide(self):
        ...
        setting = AppSettings.objects.create(category="SYSTEM", key="maintenance_mode", value={"enabled": False})
    ...
    def test_app_setting_string_representation_user_specific(self, user_factory):
        ...
        user = user_factory()
        setting = AppSettings.objects.create(
            category="NOTIFICATION", key="email_enabled", value={"enabled": True}, user=user
        )
    ...
    def test_get_value_unencrypted(self):
        ...
        setting = AppSettings.objects.create(
            category="ANALYTICS", key="tracking_id", value={"id": "UA-12345"}, is_encrypted=False
        )
    ...
    def test_set_value_unencrypted(self):
        ...
        setting = AppSettings.objects.create(category="SYSTEM", key="test_key", value={})
    ...
    def test_set_value_encrypted(self):
        ...
        setting = AppSettings.objects.create(category="PAYMENT", key="api_key", value={})
    ...
    def test_get_setting_class_method(self):
        ...
        AppSettings.objects.create(category="SYSTEM", key="site_name", value={"name": "LifePlace"})
    ...
    def test_get_setting_returns_default_when_not_found(self):
        ...
        result = AppSettings.get_setting("SYSTEM", "nonexistent_key", default={"fallback": True})
    ...
    def test_get_setting_user_specific(self, user_factory):
        ...
        user = user_factory()
        AppSettings.objects.create(category="NOTIFICATION", key="dark_mode", value={"enabled": True}, user=user)
    ...
    def test_set_setting_class_method_creates_new(self):
        ...
        setting = AppSettings.set_setting(
            category="SYSTEM", key="new_setting", value={"test": True}, description="New test setting"
        )
    ...
    def test_set_setting_class_method_updates_existing(self):
        ...
        setting = AppSettings.set_setting("SYSTEM", "update_me", {"updated": True}, description="Updated description")
    ...
    def test_unique_together_constraint(self, user_factory):
        ...
        user = user_factory()
        AppSettings.objects.create(category="SYSTEM", key="unique_test", value={"test": 1}, user=user)

        with pytest.raises(IntegrityError):
            AppSettings.objects.create(category="SYSTEM", key="unique_test", value={"test": 2}, user=user)
...
class TestCurrencySettingsModel:
    ...
    def test_currency_settings_string_representation_user(self, user_factory):
        ...
        user = user_factory()
        settings = CurrencySettings.objects.create(user=user, default_currency="USD")
    ...
    def test_clean_adds_default_to_enabled_currencies(self):
        ...
        settings = CurrencySettings(default_currency="USD", enabled_currencies=["PHP", "EUR"])
        settings.clean()
    ...
    def test_clean_sets_default_enabled_currencies_when_empty(self):
        ...
        settings = CurrencySettings(default_currency="PHP", enabled_currencies=[])
        settings.clean()
    ...
    def test_get_system_settings_returns_existing(self):
        ...
        created = CurrencySettings.objects.create(default_currency="USD", enabled_currencies=["USD", "PHP"])
    ...
    def test_get_user_settings_falls_back_to_system(self, user_factory):
        ...
        CurrencySettings.objects.create(default_currency="SGD", enabled_currencies=["SGD"])
    ...
    def test_format_amount_php_default(self):
        ...
        settings = CurrencySettings.objects.create(default_currency="PHP", decimal_places=0, display_format="symbol")
    ...
    def test_format_amount_usd_with_decimals(self):
        ...
        settings = CurrencySettings.objects.create(default_currency="USD", decimal_places=2, display_format="symbol")
    ...
    def test_format_amount_with_code_format(self):
        ...
        settings = CurrencySettings.objects.create(default_currency="EUR", decimal_places=2, display_format="code")
    ...
    def test_format_amount_with_both_format(self):
        ...
        settings = CurrencySettings.objects.create(default_currency="PHP", decimal_places=0, display_format="both")
    ...
    def test_format_amount_with_custom_separator(self):
        ...
        settings = CurrencySettings.objects.create(default_currency="PHP", decimal_places=0, thousands_separator=" ")
    ...
    def test_to_dict(self):
        ...
        settings = CurrencySettings.objects.create(
            default_currency="PHP", enabled_currencies=["PHP", "USD"], display_format="symbol", decimal_places=0
        )
...
class TestLegalDocumentModel:
    ...
    def test_legal_document_string_representation(self):
        ...
        doc = LegalDocument.objects.create(document_type="PRIVACY_POLICY", version="2.1")
    ...
    def test_effective_date_nullable(self):
        ...
        doc = LegalDocument.objects.create(document_type="TERMS_OF_SERVICE", effective_date=None)
    ...
    def test_effective_date_can_be_set(self):
        ...
        doc = LegalDocument.objects.create(document_type="PRIVACY_POLICY", effective_date=effective)
    ...
    def test_last_updated_by_relationship(self, user_factory):
        ...
        user = user_factory()
        doc = LegalDocument.objects.create(document_type="TERMS_OF_SERVICE", last_updated_by=user)
...
class TestMobileAppVersionModel:
    ...
    def test_mobile_app_version_string_representation(self):
        ...
        config = MobileAppVersion.objects.create(
            platform="android", minimum_required_version="2.0.0", recommended_version="2.1.0", latest_version="2.2.0"
        )
    ...
    def test_default_messages(self):
        ...
        config = MobileAppVersion.objects.create(
            platform="ios", minimum_required_version="1.0.0", recommended_version="1.0.0", latest_version="1.0.0"
        )
    ...
    def test_feature_flags_json_field(self):
        ...
        config = MobileAppVersion.objects.create(
            ...
            recommended_version="1.0.0",
            latest_version="1.0.0",
            feature_flags={"dark_mode": True, "new_checkout": False, "beta_features": ["feature_a", "feature_b"]},
        )
...
class TestCompanySettingsModel:
    ...
    def test_create_company_settings(self):
        ...
        settings = CompanySettings.objects.create(company_name="Test Company", email="test@company.com")
    ...
    def test_company_settings_string_representation(self):
        ...
        settings = CompanySettings.objects.create(company_name="Custom Events Co")
    ...
    def test_get_settings_returns_existing(self):
        ...
        CompanySettings.objects.all().delete()
        created = CompanySettings.objects.create(pk=1, company_name="Existing Company")
    ...
    def test_brand_colors_validation(self):
        ...
        settings = CompanySettings.objects.create(
            primary_color="#123456", secondary_color="#abcdef", accent_color="#AABBCC"
        )
