...
def inactive_template(db, event_type_factory):
    ...
    return QuoteTemplate.objects.create(
        name="Inactive Template", event_type=event_type, terms_and_conditions="Terms", is_active=False
    )
...
class TestQuoteTemplateViewSet:
    ...
    def test_list_templates_filter_by_event_type(self, admin_client, quote_template):
        ...
        response = admin_client.get("/api/sales/templates/", {"event_type": quote_template.event_type.id})
    ...
    def test_update_template(self, admin_client, quote_template):
        ...
        data = {"name": "Updated Template Name", "is_active": False}

        response = admin_client.patch(f"/api/sales/templates/{quote_template.id}/", data, format="json")
    ...
    def test_for_event_type_action(self, admin_client, quote_template):
        ...
        response = admin_client.get(
            "/api/sales/templates/for_event_type/", {"event_type": quote_template.event_type.id}
        )
...
class TestQuoteTemplateProductViewSet:
    ...
    def test_create_template_product(self, admin_client, quote_template, product_category):
        ...
        data = {"template": quote_template.id, "product": new_product.id, "quantity": 2, "is_required": False}

        response = admin_client.post("/api/sales/template-products/", data, format="json")
    ...
    def test_update_template_product(self, admin_client, quote_template):
        ...
        response = admin_client.patch(f"/api/sales/template-products/{template_product.id}/", data, format="json")
    ...
    def test_delete_template_product(self, admin_client, quote_template):
        ...
        response = admin_client.delete(f"/api/sales/template-products/{template_product.id}/")
...
class TestEventQuoteViewSet:
    ...
    def test_create_quote(self, admin_client, event_factory):
        ...
        data = {"event": event.id, "valid_until": (timezone.now().date() + timedelta(days=30)).isoformat()}
    ...
    def test_create_quote_with_template(self, admin_client, event_factory, quote_template, default_tax_rate):
        ...
        data = {"event": event.id, "template": quote_template.id}
    ...
    def test_update_quote(self, admin_client, draft_quote):
        ...
        response = admin_client.patch(f"/api/sales/quotes/{draft_quote.id}/", data, format="json")
    ...
    def test_for_event_action(self, admin_client, draft_quote):
        ...
        response = admin_client.get("/api/sales/quotes/for_event/", {"event_id": draft_quote.event.id})
    ...
    def test_reject_action(self, admin_client, sent_quote):
        ...
        response = admin_client.post(f"/api/sales/quotes/{sent_quote.id}/reject/", data, format="json")
    ...
    def test_activities_action(self, admin_client, quote_with_line_items):
        ...
        QuoteActivity.objects.create(quote=quote_with_line_items, action="CREATED", notes="Quote created")
...
class TestQuoteLineItemViewSet:
    ...
    def test_create_line_item_with_product(self, admin_client, draft_quote, product_option, default_tax_rate):
        ...
        data = {"quote": draft_quote.id, "product_id": product_option.id, "quantity": 2}
    ...
    def test_update_line_item(self, admin_client, quote_with_line_items):
        ...
        response = admin_client.patch(f"/api/sales/line-items/{line_item.id}/", data, format="json")
    ...
    def test_product_venues_action(self, admin_client, product_option):
        ...
        response = admin_client.get("/api/sales/line-items/product_venues/", {"product_id": product_option.id})
    ...
    def test_calculate_pricing_action(self, admin_client, product_option, default_tax_rate):
        ...
        data = {"product_id": product_option.id, "quantity": 1}

        response = admin_client.post("/api/sales/line-items/calculate_pricing/", data, format="json")
    ...
    def test_calculate_pricing_action_requires_product(self, admin_client):
        ...
        response = admin_client.post("/api/sales/line-items/calculate_pricing/", {"quantity": 1}, format="json")
...
class TestQuoteOptionViewSet:
    ...
    def test_list_options_by_quote(self, admin_client, quote_with_options):
        ...
        response = admin_client.get("/api/sales/options/", {"quote": quote_with_options.id})
    ...
    def test_create_option(self, admin_client, draft_quote):
        ...
        data = {
            ...
            "is_selected": False,
            "items": [{"description": "Venue", "quantity": 1, "unit_price": "5000.00", "total": "5000.00"}],
        }
    ...
    def test_update_option(self, admin_client, quote_with_options):
        ...
        response = admin_client.patch(f"/api/sales/options/{option.id}/", data, format="json")
    ...
    def test_select_option_deselects_others(self, admin_client, draft_quote):
        ...
        option1 = QuoteOption.objects.create(
            quote=draft_quote, name="Option 1", description="", total_price=Decimal("5000.00"), is_selected=True
        )
        option2 = QuoteOption.objects.create(
            quote=draft_quote, name="Option 2", description="", total_price=Decimal("7000.00"), is_selected=False
        )
...
class TestClientEventQuoteViewSet:
    ...
    def test_list_client_quotes_shows_only_client_quotes(self, authenticated_client, event_factory, user_factory):
    ...
    def test_list_client_quotes_excludes_draft(self, authenticated_client, event_factory, user_factory):
    ...
    def test_retrieve_client_quote_logs_activity(self, authenticated_client, event_factory, user_factory):
    ...
    def test_client_accept_action(self, authenticated_client, event_factory, user_factory):
        ...
        response = client.post(
            f"/api/sales/client/quotes/{quote.id}/accept/", {"signature_data": "base64-signature"}, format="json"
        )

        assert response.status_code == status.HTTP_200_OK
        assert response.data["status"] == "ACCEPTED"

    def test_client_accept_non_sent_quote_fails(self, authenticated_client, event_factory, user_factory):
    ...
    def test_client_reject_action(self, authenticated_client, event_factory, user_factory):
        ...
        client = authenticated_client(user=client_user)
        response = client.post(
            f"/api/sales/client/quotes/{quote.id}/reject/", {"reason": "Too expensive"}, format="json"
        )

        assert response.status_code == status.HTTP_200_OK
        assert response.data["status"] == "REJECTED"

    def test_client_reject_requires_reason(self, authenticated_client, event_factory, user_factory):
    ...
    @patch("core.domains.sales.pdf_service.QuotePDFService.generate_quote_pdf")
    def test_client_download_pdf_action(self, mock_pdf, authenticated_client, event_factory, user_factory):
    ...
    def test_client_cannot_access_others_quotes(self, authenticated_client, event_factory, user_factory):
