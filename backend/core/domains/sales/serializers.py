...
class QuoteTemplateProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "template", "product", "product_details", "quantity", "is_required", "created_at", "updated_at"]
...
class QuoteActivitySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = QuoteActivity
        fields = ["id", "quote", "action", "action_by", "action_by_name", "notes", "created_at", "updated_at"]
        read_only_fields = ["id", "created_at", "updated_at"]
...
class QuoteReminderSerializer(serializers.ModelSerializer):
    class Meta:
        model = QuoteReminder
        fields = ["id", "quote", "scheduled_date", "is_sent", "sent_at", "message", "created_at", "updated_at"]
        read_only_fields = ["id", "created_at", "updated_at"]
...
class ClientEventQuoteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = [
            ...
            "rejected_at",
            "notes",
            "client_message",  # Make notes read-only
            "created_at",
        ]
