...
class TestClientContractViewSet:
    ...
    def test_sign_contract(
        ...
        response = client.post(
            f'/api/contracts/client/contracts/{contract.id}/sign/',
            payload,
            format='json'
        )
    ...
    def test_sign_contract_already_signed_by_client(
        self, authenticated_client, event_factory, event_contract_factory,
        contract_template_factory, contract_signature_factory, user_factory
    ):
    ...
    def test_download_pdf_signed_contract(
        self, mock_pdf_service, authenticated_client, event_factory,
        event_contract_factory, user_factory
    ):
    ...
    def test_amendments_action(
        self, authenticated_client, event_factory, event_contract_factory,
        contract_amendment_factory, user_factory
    ):
    ...
    def test_documents_action(
        self, authenticated_client, event_factory, event_contract_factory,
        contract_document_factory, user_factory
    ):
...
class TestClientSignatureViewSet:
    ...
    def test_list_signatures_client_only_sees_own(
        self, authenticated_client, event_factory, event_contract_factory,
        contract_signature_factory, user_factory
    ):
...
class TestAdminAccessToClientEndpoints:
    ...
    def test_admin_sees_all_contracts(
        self, admin_client, event_factory, event_contract_factory, user_factory
    ):
    ...
    def test_admin_can_access_any_contract(
        self, admin_client, event_factory, event_contract_factory, user_factory
    ):
