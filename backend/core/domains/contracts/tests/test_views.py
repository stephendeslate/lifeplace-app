...
class TestContractTemplateViewSet:
    ...
    def test_filter_templates_by_event_type(
        self, admin_client, contract_template_factory, event_type_factory
    ):
    ...
    def test_for_event_type_action(self, admin_client, contract_template_factory, event_type_factory):
        ...
        response = admin_client.get(
            f'/api/contracts/templates/for_event_type/?event_type={wedding_type.id}'
        )
    ...
    def test_preview_template(self, admin_client, contract_template_factory):
        ...
        response = admin_client.post(
            f'/api/contracts/templates/{template.id}/preview/',
            payload,
            format='json'
        )
    ...
    def test_preview_template_with_event(
        self, admin_client, contract_template_factory, event_factory
    ):
...
class TestEventContractViewSet:
    ...
    def test_create_contract_from_template(
        self, admin_client, event_factory, contract_template_factory
    ):
    ...
    def test_update_contract(self, admin_client, event_contract_factory):
        ...
        payload = {'status': 'SENT'}
        response = admin_client.patch(
            f'/api/contracts/contracts/{contract.id}/',
            payload,
            format='json'
        )
    ...
    def test_void_contract(self, admin_client, event_contract_factory):
        ...
        response = admin_client.post(
            f'/api/contracts/contracts/{contract.id}/void/',
            payload,
            format='json'
        )
    ...
    def test_add_signature_to_contract(
        ...
        response = admin_client.post(
            f'/api/contracts/contracts/{contract.id}/add_signature/',
            payload,
            format='json'
        )
    ...
    def test_get_signatures_for_contract(
        self, admin_client, event_contract_factory, contract_signature_factory
    ):
    ...
    def test_request_amendment(
        ...
        response = admin_client.post(
            f'/api/contracts/contracts/{contract.id}/request_amendment/',
            payload,
            format='json'
        )
    ...
    def test_get_amendments_for_contract(
        self, admin_client, event_contract_factory, contract_amendment_factory
    ):
    ...
    def test_add_document_to_contract(
        self, admin_client, event_contract_factory, mocker
    ):
        ...
        response = admin_client.post(
            f'/api/contracts/contracts/{contract.id}/add_document/',
            payload,
            format='multipart'
        )
    ...
    def test_get_documents_for_contract(
        self, admin_client, event_contract_factory, contract_document_factory
    ):
    ...
    def test_add_note_to_contract(self, admin_client, event_contract_factory):
        ...
        response = admin_client.post(
            f'/api/contracts/contracts/{contract.id}/add_note/',
            payload,
            format='json'
        )
...
class TestContractSignatureViewSet:
    ...
    def test_verify_signature(self, admin_client, contract_signature_factory):
        ...
        response = admin_client.post(
            f'/api/contracts/signatures/{signature.id}/verify/',
            payload,
            format='json'
        )
...
class TestContractAmendmentViewSet:
    ...
    def test_approve_amendment(self, admin_client, contract_amendment_factory):
        ...
        response = admin_client.post(
            f'/api/contracts/amendments/{amendment.id}/approve/',
            payload,
            format='json'
        )
    ...
    def test_reject_amendment(self, admin_client, contract_amendment_factory):
        ...
        response = admin_client.post(
            f'/api/contracts/amendments/{amendment.id}/reject/',
            payload,
            format='json'
        )
    ...
    def test_create_contract_from_amendment(
        ...
        response = admin_client.post(
            f'/api/contracts/amendments/{amendment.id}/create_contract/',
            {},
            format='json'
        )
...
class TestContractDocumentViewSet:
    ...
    def test_inactive_documents_not_shown_by_default(
        self, admin_client, contract_document_factory
    ):
...
class TestClientUserContractAccess:
    ...
    def test_client_cannot_access_other_event_contracts(
        ...
        other_event = event_factory(client=other_user)
        other_contract = event_contract_factory(event=other_event)

        client = authenticated_client(user=client_user)
        response = client.get(
            f'/api/contracts/contracts/for_event/?event_id={other_event.id}'
        )
