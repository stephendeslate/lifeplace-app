...
def mock_currency_settings(mocker):
    ...
    mocker.patch("core.domains.settings.models.CurrencySettings.get_system_settings", return_value=mock_settings)
...
def mock_payment_settings(mocker):
    ...
    mocker.patch("core.domains.payments.models.PaymentSettings.get_default_settings", return_value=mock_settings)
    return mock_settings
...
class TestContractContextServiceBasic:
    ...
    def test_generate_event_context_merges_additional_context(self, event_factory, mock_currency_settings):
    ...
    def test_generate_event_context_additional_overrides(self, event_factory, mock_currency_settings):
...
class TestClientInformation:
    ...
    def test_client_name_fallback_to_email(self, event_factory, user_factory, mock_currency_settings):
    ...
    def test_includes_client_first_last_name(self, event_factory, user_factory, mock_currency_settings):
...
class TestDateFormatting:
    ...
    def test_end_date_none_handling(self, event_factory, mock_currency_settings):
        ...
        event = event_factory(start_date=timezone.make_aware(datetime(2024, 6, 20, 14, 0)), end_date=None)
...
class TestPaymentTermsAndPolicies:
    ...
    def test_payment_terms_from_preferences(self, event_factory, mock_currency_settings):
        ...
        event = event_factory(preferences={"payment_terms": "Full payment due 30 days before event"})
    ...
    def test_cancellation_policy_from_preferences(self, event_factory, mock_currency_settings):
        ...
        event = event_factory(preferences={"cancellation_policy": "Custom cancellation policy text"})
    ...
    def test_cancellation_policy_default(self, event_factory, mock_currency_settings):
        ...
        assert "refund" in context["cancellation_policy"].lower() or "deposit" in context["cancellation_policy"].lower()
...
class TestComputedFields:
    ...
    def test_days_until_event(self, event_factory, mock_currency_settings):
        ...
        event = event_factory(start_date=timezone.make_aware(datetime(2024, 6, 25, 14, 0)))
    ...
    def test_event_in_past(self, event_factory, mock_currency_settings):
        ...
        event = event_factory(start_date=timezone.make_aware(datetime(2024, 6, 15, 14, 0)))
...
class TestGetAvailableVariables:
    ...
    def test_variable_descriptions(self):
        ...
        for _var_name, description in variables.items():
...
class TestFormatPreferences:
    ...
    def test_formats_preferences_dict(self, event_factory, mock_currency_settings):
        ...
        event = event_factory(preferences={"guest_count": 100, "special_requests": "Vegetarian options"})
...
class TestErrorHandling:
    ...
    def test_logs_on_error(self, event_factory, mocker, mock_currency_settings):
        ...
        """
        mocker.patch("core.domains.contracts.context_service.logger")
...
class TestPaymentDepositInfo:
    ...
    def test_includes_deposit_percentage(self, event_factory, mock_currency_settings, mock_payment_settings):
    ...
    def test_includes_deposit_amount(self, event_factory, mock_currency_settings, mock_payment_settings):
...
class TestServicesDescription:
    ...
    def test_services_from_event_type(self, event_factory, event_type_factory, mock_currency_settings):
