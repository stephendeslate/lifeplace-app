...
class TestClientViewSetRetrieve:
    ...
    def test_retrieve_client_as_admin(self, admin_client, user_factory):
        ...
        client = user_factory(role="CLIENT", email="client@example.com", first_name="John", last_name="Doe")
...
class TestClientViewSetCreate:
    ...
    def test_create_client_as_admin(self, admin_client):
        ...
        data = {"email": "newclient@example.com", "first_name": "New", "last_name": "Client", "is_active": True}
...
class TestClientViewSetUpdate:
    ...
    def test_update_client_as_admin(self, admin_client, user_factory):
        ...
        data = {"email": client.email, "first_name": "New", "last_name": "Name"}
    ...
    def test_update_client_profile(self, admin_client, user_factory):
        ...
        data = {"profile": {"phone": "+639987654321", "company": "Updated Company"}}
...
class TestClientInvitationViewSetAccept:
    ...
    def test_accept_invitation(self, api_client, user_factory):
        ...
        response = api_client.post(f"/api/clients/invitations/{invitation.id}/accept/", data, format="json")
    ...
    def test_accept_invitation_password_mismatch(self, api_client, user_factory):
        ...
        data = {"password": "password123", "confirm_password": "differentpassword"}
    ...
    def test_accept_nonexistent_invitation_fails(self, api_client):
        ...
        response = api_client.post(f"/api/clients/invitations/{fake_id}/accept/", data, format="json")
    ...
    def test_all_actions_require_admin(self, client_user_client, user_factory):
        ...
        assert (
            client_user_client.post(
                "/api/clients/", {"email": "new@example.com", "first_name": "New", "last_name": "Client"}, format="json"
            ).status_code
        ...
        # Update
        assert (
            client_user_client.patch(f"/api/clients/{client.id}/", {"first_name": "Updated"}, format="json").status_code
            == status.HTTP_403_FORBIDDEN
        )
        ...
        # Send invitation
        assert (
            client_user_client.post(f"/api/clients/{client.id}/send_invitation/").status_code
            == status.HTTP_403_FORBIDDEN
        )
