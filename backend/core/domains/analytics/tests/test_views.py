...
class TestAnalyticsDateParsing:
    ...
    def test_dashboard_with_custom_date_range(self, admin_client):
        ...
        response = admin_client.get("/api/analytics/dashboard/", {"start_date": start_date, "end_date": end_date})
    ...
    def test_dashboard_with_invalid_date_uses_default(self, admin_client):
        ...
        response = admin_client.get(
            "/api/analytics/dashboard/", {"start_date": "invalid-date", "end_date": "also-invalid"}
        )
...
class TestDashboardKPIsEndpoint:
    ...
    def test_dashboard_kpis_with_data(self, admin_client, event_factory, payment_factory, user_factory):
...
class TestSalesEndpoints:
    ...
    def test_bookings_summary_with_period_param(self, admin_client):
        ...
        response = admin_client.get("/api/analytics/sales/bookings/", {"period": "weekly"})

        assert response.status_code == status.HTTP_200_OK

    def test_bookings_summary_with_data(self, admin_client, event_factory, user_factory):
    ...
    def test_reservation_pipeline_with_data(self, admin_client, event_factory, user_factory):
...
class TestEventsEndpoints:
    ...
    def test_package_performance_with_limit(self, admin_client):
        ...
        response = admin_client.get("/api/analytics/events/packages/", {"limit": 5})
...
class TestCustomersEndpoints:
    ...
    def test_customer_list_with_limit(self, admin_client):
        ...
        response = admin_client.get("/api/analytics/customers/list/", {"limit": 10})
...
class TestBookingFlowAnalyticsEndpoints:
    ...
    def test_booking_flow_funnel_with_flow_id(self, admin_client):
        ...
        response = admin_client.get("/api/analytics/booking-flow/funnel/", {"flow_id": "1"})
    ...
    def test_booking_flow_abandonment_with_flow_id(self, admin_client):
        ...
        response = admin_client.get("/api/analytics/booking-flow/abandonment/", {"flow_id": "1"})
...
class TestQuestionnaireAnalyticsEndpoints:
    ...
    def test_questionnaire_problem_fields_with_threshold(self, admin_client):
        ...
        response = admin_client.get("/api/analytics/questionnaires/problem-fields/", {"threshold": 70})
...
class TestAnalyticsExportFormats:
    ...
    def test_bookings_summary_csv_export(self, admin_client):
        ...
        """
        response = admin_client.get("/api/analytics/sales/bookings/", {"format": "csv"})
    ...
    def test_bookings_summary_excel_export(self, admin_client):
        ...
        """
        response = admin_client.get("/api/analytics/sales/bookings/", {"format": "excel"})
    ...
    def test_revenue_csv_export(self, admin_client):
        ...
        response = admin_client.get("/api/analytics/sales/revenue/", {"format": "csv"})

        assert response.status_code in [status.HTTP_200_OK, status.HTTP_204_NO_CONTENT, status.HTTP_404_NOT_FOUND]

    def test_lead_sources_csv_export(self, admin_client):
        """Test lead sources with CSV export format."""
        response = admin_client.get("/api/analytics/customers/leads/", {"format": "csv"})

        assert response.status_code in [status.HTTP_200_OK, status.HTTP_204_NO_CONTENT, status.HTTP_404_NOT_FOUND]

    def test_customer_list_csv_export(self, admin_client):
        """Test customer list with CSV export format."""
        response = admin_client.get("/api/analytics/customers/list/", {"format": "csv"})
...
class TestAnalyticsResponseFormats:
    ...
    def test_numeric_values_are_serializable(self, admin_client, event_factory, payment_factory, user_factory):
...
class TestAnalyticsIntegration:
    ...
    def test_full_analytics_workflow(self, admin_client, event_factory, payment_factory, user_factory):
    ...
    def test_date_range_affects_results(self, admin_client, event_factory, user_factory):
        ...
        response1 = admin_client.get(
            "/api/analytics/dashboard/",
            {"start_date": (now - timedelta(days=30)).isoformat(), "end_date": now.isoformat()},
        )
