...
class TestQuestionnaireStats:
    ...
    def test_stats_for_questionnaire_with_fields(
    ...
    def test_stats_with_responses(
        self, questionnaire_factory, questionnaire_field_factory,
        event_factory, questionnaire_response_factory
    ):
...
class TestAllQuestionnairesSummary:
    ...
    def test_summary_multiple_questionnaires(
        self, questionnaire_factory, questionnaire_field_factory
    ):
...
class TestResponseTrends:
    ...
    def test_trends_respects_days_parameter(
        self, questionnaire_factory, questionnaire_field_factory
    ):
