...
class TestQuestionnaireViewSet:
    ...
    def test_list_questionnaires_filter_by_event_type(
        self, admin_client, questionnaire_factory, event_type_factory
    ):
    ...
    def test_duplicate_questionnaire(
    ...
    def test_get_questionnaire_fields_action(
        self, admin_client, questionnaire_factory, questionnaire_field_factory
    ):
    ...
    def test_get_questionnaire_analytics(
        self, admin_client, questionnaire_factory, questionnaire_field_factory
    ):
...
class TestQuestionnaireResponseViewSet:
    ...
    def test_list_responses_as_admin(
        self, admin_client, questionnaire_response_factory
    ):
    ...
    def test_save_event_responses_bulk(
        self, admin_client, event_factory, questionnaire_field_factory
    ):
...
class TestQuestionnaireViewSetPermissions:
    ...
    def test_client_can_access_questionnaires(
        self, client_user_client, questionnaire_factory
    ):
...
class TestQuestionnaireFieldViewSetPermissions:
    ...
    def test_client_cannot_manage_fields(
        self, client_user_client, questionnaire_factory
    ):
