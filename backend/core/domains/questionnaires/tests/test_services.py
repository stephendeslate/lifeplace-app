...
class TestQuestionnaireService:
    ...
    def test_get_all_questionnaires_filter_by_event_type(
    ...
    def test_update_questionnaire_with_fields(
    ...
    def test_duplicate_questionnaire_with_custom_name(
        ...
        duplicate = QuestionnaireService.duplicate_questionnaire(
            original.id,
...
class TestQuestionnaireFieldService:
    ...
    def test_get_fields_for_questionnaire(
        self, questionnaire_factory, questionnaire_field_factory
    ):
    ...
    def test_create_field_duplicate_name_raises_error(
        self, questionnaire_factory, questionnaire_field_factory
    ):
        ...
        with pytest.raises(DuplicateQuestionnaireField):
            QuestionnaireFieldService.create_field(
                questionnaire.id,
                {'name': 'Existing Field', 'type': 'text'}
            )
    ...
    def test_update_field(self, questionnaire_field_factory):
        ...
        updated = QuestionnaireFieldService.update_field(
            field.id,
    ...
    def test_update_field_duplicate_name_raises_error(
        self, questionnaire_factory, questionnaire_field_factory
    ):
        ...
        with pytest.raises(DuplicateQuestionnaireField):
            QuestionnaireFieldService.update_field(
                field_b.id,
                {'name': 'Field A'}
            )
...
class TestQuestionnaireResponseService:
    ...
    def test_get_responses_for_event(
    ...
    def test_create_response_invalid_boolean_raises_error(
        self, event_factory, questionnaire_field_factory
    ):
    ...
    def test_create_response_invalid_select_raises_error(
        self, event_factory, questionnaire_field_factory
    ):
    ...
    def test_create_response_validates_multi_select(
        self, event_factory, questionnaire_field_factory
    ):
    ...
    def test_create_response_invalid_multi_select_raises_error(
        self, event_factory, questionnaire_field_factory
    ):
    ...
    def test_update_response(self, questionnaire_response_factory):
        ...
        updated = QuestionnaireResponseService.update_response(
            response.id,
            {'value': 'Updated'}
        )
    ...
    def test_update_response_validates_value(
        ...
        with pytest.raises(InvalidResponseValue):
            QuestionnaireResponseService.update_response(
                response.id,
                {'value': 'invalid'}
            )
    ...
    def test_save_event_responses(
        self, event_factory, questionnaire_factory, questionnaire_field_factory
    ):
    ...
    def test_save_event_responses_skips_empty_values(
        self, event_factory, questionnaire_field_factory
    ):
