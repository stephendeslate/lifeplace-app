...
class TestQuestionnaireSerializer:
    ...
    def test_serialize_questionnaire_with_fields_count(self, questionnaire_factory, questionnaire_field_factory):
...
class TestQuestionnaireDetailSerializer:
    ...
    def test_serialize_questionnaire_with_fields(self, questionnaire_factory, questionnaire_field_factory):
        """Test detailed serialization includes fields."""
        questionnaire = questionnaire_factory(name="Detail Test")
        questionnaire_field_factory(questionnaire=questionnaire, name="Field 1", type="text", order=1)
        questionnaire_field_factory(questionnaire=questionnaire, name="Field 2", type="email", order=2)
    ...
    def test_serialize_questionnaire_with_event_type(self, questionnaire_factory, event_type_factory):
...
class TestQuestionnaireWithFieldsSerializer:
    ...
    def test_update_questionnaire_replaces_fields(self, questionnaire_factory, questionnaire_field_factory):
        ...
        serializer = QuestionnaireWithFieldsSerializer(questionnaire, data=data, partial=True)
...
class TestQuestionnaireResponseSerializer:
    ...
    def test_serialize_response(self, event_factory, questionnaire_field_factory, questionnaire_response_factory):
        """Test basic response serialization."""
        event = event_factory()
        field = questionnaire_field_factory(name="Test Field", type="text")
        response = questionnaire_response_factory(event=event, field=field, value="Test Answer")
    ...
    def test_serialize_boolean_response(
        ...
        response = questionnaire_response_factory(event=event, field=field, boolean_yes=True)
    ...
    def test_serialize_guest_count_json_response(
        ...
        event = event_factory()
        field = questionnaire_field_factory(guests_field=True)
        response = questionnaire_response_factory(event=event, field=field, guest_count_json=True)
