...
class FieldValidator:
    ...
    @classmethod
    def _validate_time(cls, value: str) -> Tuple[bool, Optional[str]]:
    ...
    @classmethod
    def _validate_select(cls, value: str, options: List[str] = None) -> Tuple[bool, Optional[str]]:
    ...
    @classmethod
    def _validate_multi_select(cls, value: str, options: List[str] = None) -> Tuple[bool, Optional[str]]:
    ...
    @classmethod
    def _validate_guests(cls, value: str, categories: List[str] = None) -> Tuple[bool, Optional[str]]:
        """
