...
class ProductCategoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Business Rules", {"fields": ("is_active", "requires_venue", "typical_duration_hours")}),
    )
...
class ProductOptionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "description", "category", "type")}),
        (
            "Pricing",
            {
        ...
        ("Booking Rules", {"fields": ("advance_booking_days", "maximum_booking_days")}),
        ("Metadata", {"fields": ("sku", "sort_order")}),
        (
            "Event Types",
            {
                "fields": ("event_types",),
...
class DiscountAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Discount Configuration", {"fields": ("discount_type", "application_type", "value", "currency")}),
        ("Validity", {"fields": ("is_active", "valid_from", "valid_until")}),
        ("Usage Limits", {"fields": ("max_uses", "max_uses_per_client", "current_uses")}),
        ("Requirements", {"fields": ("minimum_order_amount", "minimum_hours")}),
        ("Applicability", {"fields": ("applicable_products", "applicable_categories")}),
    )
