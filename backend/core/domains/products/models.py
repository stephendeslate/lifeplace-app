...
class ProductCategory(BaseModel):
    ...
    typical_duration_hours = models.PositiveIntegerField(
        null=True, blank=True, help_text="Typical event duration in hours"
    )
...
class ProductOption(BaseModel):
    ...
    is_tax_inclusive = models.BooleanField(
        default=False, help_text="If True, base_price already includes tax (no additional tax applied)"
    )
    ...
    is_highlighted = models.BooleanField(
        default=False, help_text="Highlight this tier on the rates page (e.g., 'Popular' badge)"
    )
    ...
    maximum_booking_days = models.PositiveIntegerField(
        null=True, blank=True, help_text="Maximum days in advance for booking"
    )
    ...
    featured_image = models.ImageField(
        upload_to="products/images/", null=True, blank=True, help_text="Main image shown in listings and cards"
    )
    gallery_images = models.JSONField(default=list, blank=True, help_text="List of image URLs for product gallery")
    ...
    is_custom = models.BooleanField(default=False, help_text="True if this package was generated from venue selection")
...
class Discount(BaseModel):
    ...
    def is_valid(self):
        ...
        if self.valid_until and today > self.valid_until:
            return False
        return not (self.max_uses and self.current_uses >= self.max_uses)
    ...
    def can_be_used_by_client(self, client, order_amount=None, order_hours=None):
        ...
        return not (self.minimum_hours and order_hours and order_hours < self.minimum_hours)
