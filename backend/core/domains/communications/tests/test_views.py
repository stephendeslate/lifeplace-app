...
class TestCommunicationTemplateViewSet:
    ...
    def test_create_template_as_admin(self, mock_validate, admin_client):
        ...
        response = admin_client.post("/api/communications/templates/", data, format="json")
    ...
    def test_create_template_as_client_forbidden(self, client_user_client):
        ...
        response = client_user_client.post("/api/communications/templates/", data, format="json")
    ...
    def test_update_template_as_admin(self, mock_validate, admin_client):
        ...
        response = admin_client.put(f"/api/communications/templates/{template.id}/", data, format="json")
    ...
    def test_update_template_as_client_forbidden(self, client_user_client):
        ...
        response = client_user_client.put(
            f"/api/communications/templates/{template.id}/", {"body_template": "Hacked body"}, format="json"
        )
    ...
    def test_delete_template_as_client_forbidden(self, client_user_client):
        ...
        response = client_user_client.delete(f"/api/communications/templates/{template.id}/")
    ...
    def test_history_as_admin(self, admin_client, user_factory):
        ...
        response = admin_client.get(f"/api/communications/templates/{template.id}/history/")
    ...
    def test_history_as_client_forbidden(self, client_user_client):
        ...
        response = client_user_client.get(f"/api/communications/templates/{template.id}/history/")
    ...
    def test_rollback_as_admin(self, mock_cache, admin_client, user_factory):
        ...
        response = admin_client.post(
            f"/api/communications/templates/{template.id}/rollback/", {"version": 1}, format="json"
        )
    ...
    def test_rollback_missing_version(self, admin_client):
        ...
        response = admin_client.post(f"/api/communications/templates/{template.id}/rollback/", {}, format="json")
    ...
    def test_duplicate_auto_generate_name(self, admin_client):
        ...
        response = admin_client.post(f"/api/communications/templates/{template.id}/duplicate/", {}, format="json")
    ...
    def test_stats_as_admin(self, admin_client):
        ...
        response = admin_client.get(f"/api/communications/templates/{template.id}/stats/")
    ...
    def test_stats_as_client_forbidden(self, client_user_client):
        ...
        response = client_user_client.get(f"/api/communications/templates/{template.id}/stats/")
...
class TestCommunicationRecordViewSet:
    ...
    def test_mark_as_read(self, authenticated_client, user_factory):
        ...
        client = authenticated_client(user=client_user)
        response = client.post(f"/api/communications/records/{record.id}/mark_as_read/")
    ...
    def test_mark_as_unread(self, authenticated_client, user_factory):
        ...
        client = authenticated_client(user=client_user)
        response = client.post(f"/api/communications/records/{record.id}/mark_as_unread/")
    ...
    def test_health_check_as_admin(self, mock_service_class, admin_client):
        ...
        mock_service = Mock()
        mock_service.get_provider_health.return_value = {"MOCK": {"state": "closed", "failures": 0, "healthy": True}}
        mock_service_class.return_value = mock_service
    ...
    def test_reset_provider_as_admin(self, mock_service_class, admin_client):
        ...
        response = admin_client.post(
            "/api/communications/records/reset_provider/", {"provider_name": "MOCK"}, format="json"
        )
    ...
    def test_reset_provider_missing_name(self, admin_client):
        ...
        response = admin_client.post("/api/communications/records/reset_provider/", {}, format="json")
