...
class TestCommunicationTemplateHistory:
    ...
    def test_unique_template_version_constraint(self, user_factory):
        ...
        CommunicationTemplateHistory.create_snapshot(template=template, reason="CREATE", changed_by=admin)
    ...
    def test_history_ordering(self, user_factory):
        ...
        snapshot1 = CommunicationTemplateHistory.create_snapshot(template=template, reason="CREATE", changed_by=admin)
        snapshot2 = CommunicationTemplateHistory.create_snapshot(template=template, reason="UPDATE", changed_by=admin)
